...
{
	#region rb_TabSettings
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_TabSettings")]
	public class rb_TabSettings : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_TabSettings) ) as ArrayList;
		...
		/// table "rb_Tabs", using relation table "rb_TabSettings"
		/// </summary>
		public IList referencedrb_TabsUsingrb_TabSettings()
		{
			return new GentleList( typeof(rb_Tabs), this, typeof(rb_TabSettings));
		}
		#endregion
