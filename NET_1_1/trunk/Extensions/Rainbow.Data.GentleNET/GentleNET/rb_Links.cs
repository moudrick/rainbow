...
namespace Rainbow.Data.GentleNET
{
	...
	[Serializable]
	[TableName("rb_Links")]
	public class rb_Links : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Links) ) as ArrayList;
		...
		public static rb_Links Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Links), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Links), key ) as rb_Links;
		}
		...
		/// table "rb_Modules", using relation table "rb_Links"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Links));
		}
		#endregion
