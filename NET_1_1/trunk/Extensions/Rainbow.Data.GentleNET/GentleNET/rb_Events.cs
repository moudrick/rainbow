...
namespace Rainbow.Data.GentleNET
{
	...
	[Serializable]
	[TableName("rb_Events")]
	public class rb_Events : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Events) ) as ArrayList;
		...
		public static rb_Events Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Events), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Events), key ) as rb_Events;
		}
		...
		/// table "rb_Modules", using relation table "rb_Events"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Events));
		}
		#endregion
