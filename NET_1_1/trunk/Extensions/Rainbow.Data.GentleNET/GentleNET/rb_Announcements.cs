...
{
	#region rb_Announcements
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Announcements")]
	public class rb_Announcements : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Announcements) ) as ArrayList;
		...
		public static rb_Announcements Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Announcements), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Announcements), key ) as rb_Announcements;
		}
		...
		/// table "rb_Modules", using relation table "rb_Announcements"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Announcements));
		}
		#endregion
