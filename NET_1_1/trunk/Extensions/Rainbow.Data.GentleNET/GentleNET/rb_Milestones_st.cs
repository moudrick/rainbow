...
{
	#region rb_Milestones_st
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Milestones_st")]
	public class rb_Milestones_st : Persistent
	{
		#region Members
		...
		[TableColumn("EstCompleteDate")]
		protected DateTime estCompleteDate;
		[TableColumn("Status")]
		...
		public DateTime EstCompleteDate
		{
			get{ return estCompleteDate; }
			set{ _changed |= estCompleteDate != value; estCompleteDate = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Milestones_st) ) as ArrayList;
