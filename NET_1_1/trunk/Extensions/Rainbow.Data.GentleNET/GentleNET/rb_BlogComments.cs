...
namespace Rainbow.Data.GentleNET
{
	...
	public class rb_BlogComments : Persistent
	{
		...
		[TableColumn("DateCreated", NotNull=true)]
		...
		{
			get{ return itemID; }
			set{ _changed |= itemID != value; itemID = value; invalidatedListAll =  _changed;}
		}
		
		public string Comment
		{
			get{ return comment != null ?comment.TrimEnd() : null; }
			set{ _changed |= comment != value; comment = value; invalidatedListAll =  _changed;}
		}
		...
		public DateTime DateCreated
		{
			...
			set{ _changed |= dateCreated != value; dateCreated = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_BlogComments) ) as ArrayList;
		...
		public static rb_BlogComments Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_BlogComments), true, "BlogCommentID", id );
			return Broker.RetrieveInstance( typeof(rb_BlogComments), key ) as rb_BlogComments;
		}
