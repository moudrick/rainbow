...
namespace Rainbow.Configuration
{
	...
	public class PortalsDB
	{
		...
		private const string strGUIDTabs = "{1C575D94-70FC-4A83-80C3-2087F726CBB3}";
		private const string strLeftPane = "LeftPane";
		private const string strPortalsDirectory = "PortalsDirectory";
		...
		public int CreatePortal(int solutionID, string portalAlias, string portalName, string portalPath)
		{
			...
			int homeTabID = tabs.AddTab(portalID, "Home", 1);
			// Create a new Tab "admin"
			string localizedString = Localize.GetString("ADMIN_TAB_NAME", "Administration");
			int adminTabID = tabs.AddTab(portalID, localizedString, strAdmins, 9999);
			...
			modules.AddModule(adminTabID, 1, strContentPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDSiteSettings)), 0, strAdmins, strAllUsers, strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
			// Tabs (Admin)
			localizedString = Localize.GetString("MODULE_TABS", "Tabs");
			modules.UpdateModuleDefinitions(new Guid(strGUIDTabs), portalID, true);
			modules.AddModule(adminTabID, 2, strContentPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDTabs)), 0, strAdmins, strAllUsers, strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
			// Roles (Admin)
			...
			modules.AddModule(adminTabID, 3, strContentPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDSecurityRoles)), 0, strAdmins, strAllUsers, strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
			// Manage Users (Admin)
			...
			modules.AddModule(adminTabID, 4, strContentPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDManageUsers)), 0, strAdmins, strAllUsers, strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
			...
			modules.AddModule(adminTabID, 1, strRightPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDModules)), 0, strAdmins, strAllUsers, strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
			...
			modules.AddModule(homeTabID, -1, strLeftPane, localizedString, modules.GetModuleDefinitionByGuid(portalID, new Guid(strGUIDLogin)), 0, strAdmins, "Unauthenticated Users;Admins;", strAdmins, strAdmins, strAdmins, strAdmins, strAdmins, false, string.Empty, false, false, false);
		...
		public void CreatePortalPath(string portalPath)
		{
			...
			if (portalPath.IndexOf(pd) > -1)
				portalPath = portalPath.Substring(portalPath.IndexOf(pd) + pd.Length);
			string portalPhisicalDir = HttpContext.Current.Server.MapPath(Path.ApplicationRoot + "/" + ConfigurationSettings.AppSettings[strPortalsDirectory] + "/" + portalPath);
