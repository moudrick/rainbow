...
{
	/// <summary>
	/// The Globalized.LinkCommand class is used for a simple custom version of the
	...
	/// a button.
	/// </summary>
	[ToolboxData("<{0}:LinkCommand TextKey='' runat=server></{0}:LinkCommand>")]
	public class LinkCommand : Rainbow.UI.MobileControls.LinkCommand , IGlobalizedMobilControls
	{
