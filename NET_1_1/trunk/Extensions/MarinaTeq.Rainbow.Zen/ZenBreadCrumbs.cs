...
namespace Rainbow.UI.WebControls
{
	...
	/// </summary>
	public class ZenBreadCrumbs : System.Web.UI.WebControls.Literal 
	{ 
		...
		protected override void CreateChildControls() 
		{
			...
			if (HttpContext.Current != null)
			{
				...
				{  
					...
					{ 
						PageStripDetails tab = (Rainbow.Configuration.PageStripDetails)portalSettings.DesktopPages[i]; 

						if (Rainbow.Security.PortalSecurity.IsInRoles(tab.AuthorizedRoles)) 
			...
			{ 
				...
				{ 					
					...
					{
						sb.Append("<a href='");
						sb.Append(Rainbow.HttpUrlBuilder.BuildUrl(item.ID));
						sb.Append("'>");
