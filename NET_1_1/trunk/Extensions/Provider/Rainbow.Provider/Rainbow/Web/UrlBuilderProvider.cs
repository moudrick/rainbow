...
namespace Rainbow.Web
{
	...
	public abstract class UrlBuilderProvider : ProviderBase
	{
		...
		public abstract string BuildUrl(string targetPage, int tabID, int modID, CultureInfo culture, string customAttributes, string currentAlias, string urlKeywords);
		...
		public static UrlBuilderProvider Instance()
		{
			...
			{ // The assembly should be in \bin or GAC, so we simply need
				...
				try
				{
					cache.Insert(cacheKey, ProviderHelper.InstantiateProvider(providerSettings, typeof (UrlBuilderProvider)));
				}
