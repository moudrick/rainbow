...
namespace Rainbow.Configuration
{
	...
	public class Log4NetLogProvider : LogProvider
	{
		...
		public override void Initialize(string name, NameValueCollection configValue)
		{
			...
			GlobalContext.Properties["CodeVersion"] = new Rainbow.Configuration.LogCodeVersionProperty();
			GlobalContext.Properties["User"] = new Rainbow.Configuration.LogUserNameProperty();
			GlobalContext.Properties["RewrittenUrl"] = new Rainbow.Configuration.LogRewrittenUrlProperty();
			GlobalContext.Properties["UserAgent"] = new Rainbow.Configuration.LogUserAgentProperty();
			GlobalContext.Properties["UserIP"] = new Rainbow.Configuration.LogUserIpProperty();
			GlobalContext.Properties["UserLanguages"] = new Rainbow.Configuration.LogUserLanguagesProperty();
