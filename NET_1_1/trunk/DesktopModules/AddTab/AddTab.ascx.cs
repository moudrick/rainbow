...
namespace Rainbow.DesktopModules.AddModule
{
	...
	public class AddPage : PortalModuleControl
	{
		...
		/// 
		/// </summary>
		protected Literal tabParentLabel;
		/// <summary>
		/// 
		/// </summary>
		protected Literal tabVisibleLabel;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected Literal tabTitleLabel;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected Literal lbl_ShowMobile;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected Literal lbl_MobileTabName;
		/// <summary>
		/// 
		/// </summary>
		...
		private void Page_Load(object sender, EventArgs e)
		{
			...
			{
				BindData();
				TabTitleTextBox.Text = Localize.GetString("TAB_NAME", "New Tab Name");
			}
		}
		#endregion
		...
		private void BindData() 
		{
			...
			keys[0] = dt_Pages.Columns["TabID"];
			dt_Pages.PrimaryKey = keys;

			this.parentTabDropDown.DataSource = dt_Pages;
			this.parentTabDropDown.DataValueField = "TabID";
			this.parentTabDropDown.DataTextField = "PageOrder";
			...
			// Translate
			//parentTabDropDown.Item(0).Text = Localize.GetString("ROOT_LEVEL", "Root Level", parentTabDropDown);
		}
		#endregion
		...
		private void AddTabButton_Click(Object sender, EventArgs e) 
		{
			if(Page.IsValid)
			{
				...
				try
				{
					...
					t.ID = tabs.AddPage(portalSettings.PortalID, parentTabID, t.Name, t.Order, viewPermissionRoles, cb_ShowMobile.Checked , tb_MobileTabName.Text);
					...
					else
					{
						...
						returnTab = HttpUrlBuilder.BuildUrl("~/DesktopDefault.aspx", this.PageID, "SelectedTabID=" + t.ID.ToString());
					}
				...
				catch(Exception ex)
				{
					...
					ErrorHandler.Publish(LogLevel.Error, "There was an error with the Add Tab Module while trying to add a new tab.",ex);
					return;
				}
