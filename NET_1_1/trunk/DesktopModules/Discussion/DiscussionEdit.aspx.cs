...
namespace Rainbow.DesktopModules 
{
	...
	/// </summary>
	public class DiscussionEdit : AddEditItemPage
	{ 
		#region Declarations
		/// <summary>
		/// 
		...
		/// 
		/// </summary>
		protected Panel OriginalMessagePanel;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected Label DiscussionEditInstructions;
		#endregion
		...
		private void Page_Load(object sender, EventArgs e) 
		{
			...
			submitButton.Text = Localize.GetString("SUBMIT");
			cancelButton.Text = Localize.GetString("CANCEL");

			HtmlEditorDataType h = new HtmlEditorDataType();
			h.Value = moduleSettings["Editor"].ToString();
			BodyField = h.GetEditor(DescriptionField, ModuleID, bool.Parse(moduleSettings["ShowUpload"].ToString()), portalSettings);
			...
			if (Page.IsPostBack == false) 
			{
				...
				switch (GetMode())
					...
					case "REPLY":
						...
						DiscussionEditInstructions.Text = Localize.GetString("DS_REPLYTHISMSG");
						...
						try
						{
							if(dr.Read())
							{
								...
								{
									CreatedByUser.Text = Localize.GetString ( "UNKNOWN", "unknown");
								}
							}
						}
						finally
					...
					case "EDIT":
						...
						OriginalMessagePanel.Visible=false;
						DiscussionEditInstructions.Text = Localize.GetString("EDIT");
						...
						try
						{
							...
							if(dr.Read())
							{
								...
								{
									itemUserEmail = Localize.GetString ( "UNKNOWN", "unknown");
								}
							}
						}
						finally
		...
		override protected void OnInit(EventArgs e)
		{
            ...
            Requiredfieldvalidator1.ErrorMessage = Localize.GetString("ERROR_SUBJECT");
