...
namespace Rainbow.DesktopModules
{
	...
	/// </summary>
	public class QuizPage : ViewItemPage
	{
		protected HtmlGenericControl QuizScreen;
		protected HtmlGenericControl ResultScreen;

		protected Label lblQuiz;
		...
		override protected void OnInit(EventArgs e)
		{
            ...
            Requiredfieldvalidator1.ErrorMessage = Localize.GetString("ERROR_QUIZ_ANSWER");
