...
namespace Rainbow.DesktopModules
{
	...
	public class DatabaseTableEdit : PortalModuleControl
	{
		...
		protected Label lblConnectedError;
        ...
        private void Page_Load(object sender, EventArgs e)
		{
			...
			else
			{
				...
				lblConnectedError.Text = Localize.GetString ("TABLEEDIT_MSG_CONNECT");
			}
		...
		void BindTables()
		{
			...
			try 
			{
				...
				// Added EsperantusKeys for Localization --%>
				// Mario Endara mario@softworks.com.uy 11/05/2004 --%>
				tablelist.Items.Insert(0, Localize.GetString ("TABLEEDIT_SELECT_TABLE"));
			}
			catch (Exception ex)
			{
				lblConnectedError.Visible = true;
