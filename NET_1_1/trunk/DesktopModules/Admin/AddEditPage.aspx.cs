...
namespace Rainbow.DesktopModules
{
	...
	/// </summary>
	public class AddEditPage : AddEditItemPage
	{
		protected Literal Literal1;
		protected PlaceHolder AddEditControlPlaceHolder;
		...
		private void InitializeControl() 
		{
			...
			{
				PortalModuleControl myControl = (PortalModuleControl) this.LoadControl(Path.ApplicationRoot + "/" + this.Module.DesktopSrc);
