...
namespace Rainbow.DesktopModules
{
	...
	public class Pictures : PortalModuleControl 
	{
		...
		public Pictures()
		{
			...
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.FixedWidthHeight, Localize.GetString("PICTURES_FIXED_WIDTH_AND_HEIGHT", "Fixed width and height", this)));
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectWidth, Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_WIDTH", "Maintain aspect fixed width", this)));
			thumbnailResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectHeight, Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_HEIGHT", "Maintain aspect fixed height", this)));
			...
			originalResizeOptions.Add(new Option((int)ResizeOption.NoResize, Localize.GetString("PICTURES_DONT_RESIZE", "Don't Resize", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.FixedWidthHeight, Localize.GetString("PICTURES_FIXED_WIDTH_AND_HEIGHT", "Fixed width and height", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectWidth, Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_WIDTH", "Maintain aspect fixed width", this)));
			originalResizeOptions.Add(new Option((int)ResizeOption.MaintainAspectHeight, Localize.GetString("PICTURES_MAINTAIN_ASPECT_FIXED_HEIGHT", "Maintain aspect fixed height", this)));
			...
			repeatDirectionOptions.Add(new Option((int)RepeatDirection.Horizontal, Localize.GetString("PICTURES_HORIZONTAL", "Horizontal", this)));
			repeatDirectionOptions.Add(new Option((int)RepeatDirection.Vertical, Localize.GetString("PICTURES_VERTICAL", "Vertical", this)));
			...
			foreach(string layoutControl in Directory.GetFiles(HttpContext.Current.Server.MapPath(Rainbow.Settings.Path.ApplicationRoot + "/Design/PictureLayouts"), "*.ascx"))
			{
		...
		public override string SearchSqlSelect(int portalID, int userID, string searchString, string searchField)
		{
			...
			SearchDefinition s = new SearchDefinition("rb_Pictures", "ShortDescription", "Keywords", "CreatedByUser", "CreatedDate", "Keywords");
