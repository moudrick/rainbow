...
namespace Rainbow.DesktopModules 
{
    ...
    public class HtmlModule : PortalModuleControl
	{
		...
		const string COMPARE_BUTTON = "MODULESETTINGS_HTMLDOCUMENT_SHOW_COMPARE_BUTTON";
		...
		public HtmlModule()
		{
			...
			this._baseSettings.Add(COMPARE_BUTTON, ShowCompareButton);
		...
		private void Page_Load(object sender, EventArgs e) 
		{
			...
			HtmlLiteral = new LiteralControl(this.Content.ToString());
			HtmlLiteral.DataBinding += new EventHandler(this.HtmlLiteral_DataBinding);
			HtmlLiteral.DataBind();
			this.HtmlHolder.Controls.Add(HtmlLiteral);
		}
		...
		private void CompareButton_Click(Object sender, EventArgs e)
		{
			...
			else
			{
				...
				this.Content = Server.HtmlDecode(merger.merge());
				HtmlLiteral = new LiteralControl(this.Content.ToString());
				HtmlLiteral.DataBinding += new EventHandler(this.HtmlLiteral_DataBinding);
				HtmlLiteral.DataBind();
				this.HtmlHolder.Controls.Add(HtmlLiteral);
...
// version comparison. 10/9/2005
			...
			get
			{
				if (_btnCompare == null && HttpContext.Current != null)
				{
					if (this.CanCompare)
					{
						...
						_btnCompare.RenderAs = this.ButtonsRenderAs;
					}
				}
		...
		protected virtual int IsComparing
		{
			...
			set
			{
				ViewState["NewHtmlModuleIsComparing"] = value;
			}
		}
// end of addition
