...
namespace Rainbow.DesktopModules
{
    public class ArticlesView : ViewItemPage
	{
		...
		protected Literal goback;
		protected HyperLink editLink;
		protected Literal goBackTop;
		...
		private void Page_Load(object sender, EventArgs e)
		{
			...
			if (IsEditable)
			{
				editLink.NavigateUrl = HttpUrlBuilder.BuildUrl("~/DesktopModules/Articles/ArticlesEdit.aspx","ItemID=" + ItemID + "&mid=" + ModuleID );
