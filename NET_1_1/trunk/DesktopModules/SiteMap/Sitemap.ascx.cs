...
namespace Rainbow.DesktopModules.Sitemap
{
	...
	public class Sitemap : PortalModuleControl, INavigation
	{
		...
		public Sitemap()
		{
			...
			this._baseSettings.Add("NodeIcon", NodeIcon);
			...
			this._baseSettings.Add("RootIcon", RootIcon);
			...
			this._baseSettings.Add("IconWidth", IconWidth);
			...
			this._baseSettings.Add("IconHeight", IconHeight);
