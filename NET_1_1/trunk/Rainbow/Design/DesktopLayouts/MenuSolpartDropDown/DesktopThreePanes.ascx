...
<CC1:DESKTOPPANES id="ThreePanes" runat="server" cellspacing="2" Cellpadding="0" ShowFirstSeparator="False" ShowLastSeparator="False">
	<HORIZONTALSEPARATORTEMPLATE><TRA:IMAGE runat="server" ImageUrl="<%=LayoutManager.WebPath%>/MenuTopSolpart/images/spacer.gif" height=4></TRA:IMAGE></HORIZONTALSEPARATORTEMPLATE>
