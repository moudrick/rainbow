...
namespace Rainbow.DesktopModules.FCK.filemanager.browse
{
	...
	public class imagegallery : EditItemPage
	{
		...
		/// 
		/// </summary>
		protected Label gallerymessage;
		/// <summary>
		/// 
		/// </summary>
		protected Panel GalleryPanel;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected Button DeleteImage;
		/// <summary>
		/// 
		/// </summary>
		protected RegularExpressionValidator FileValidator;
		/// <summary>
		/// 
		/// </summary>
		protected Literal ResultsMessage;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected HtmlInputHidden FileToDelete;
		/// <summary>
		/// 
		/// </summary>
		protected HtmlInputHidden RootImagesFolder;
		/// <summary>
		/// 
		/// </summary>
		protected HtmlInputHidden CurrentImagesFolder;
		/// <summary>
		/// 
		/// </summary>
		protected Panel iframePanel;
		#endregion
