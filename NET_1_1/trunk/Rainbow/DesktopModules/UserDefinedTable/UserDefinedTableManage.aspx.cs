...
namespace Rainbow.DesktopModules 
{
	...
	public class UserDefinedTableManage : EditItemPage
	{
		protected LinkButton cmdAddField;
		protected DataGrid grdFields;
		protected LinkButton cmdCancel;
		protected Label ManageTableLabel;
		...
		public string GetFieldTypeName(string strFieldType)
		{
			switch (strFieldType)
			{
				case "String" 	: return Localize.GetString("USERTABLE_TYPE_STRING", "Text",null);
				case "Int32" 	: return Localize.GetString("USERTABLE_TYPE_INT32", "Integer",null);
				case "Decimal" 	: return Localize.GetString("USERTABLE_TYPE_DECIMAL", "Decimal",null);
				case "DateTime" : return Localize.GetString("USERTABLE_TYPE_DATETIME", "Date",null);
				case "Boolean" 	: return Localize.GetString("USERTABLE_TYPE_BOOLEAN", "True/False",null);
				case "File" 	: return Localize.GetString("USERTABLE_TYPE_FILE", "File",null);
				case "Image" 	: return Localize.GetString("USERTABLE_TYPE_IMAGE", "Image",null);
				default			: return Localize.GetString("USERTABLE_TYPE_STRING", "Text",null);
			}
		}
		...
		public UserDefinedTableType[] GetTableTypes()
		{
			...
			tableTypes[0].TypeText = Localize.GetString("USERTABLE_TYPE_STRING", "Text",null);
			tableTypes[0].TypeValue = "String";			
			tableTypes[1] = new UserDefinedTableType();
			tableTypes[1].TypeText = Localize.GetString("USERTABLE_TYPE_INT32", "Integer",null);
			tableTypes[1].TypeValue = "Int32";	
			tableTypes[2] = new UserDefinedTableType();
			tableTypes[2].TypeText = Localize.GetString("USERTABLE_TYPE_DECIMAL", "Decimal",null);
			tableTypes[2].TypeValue = "Decimal";	
			tableTypes[3] = new UserDefinedTableType();
			tableTypes[3].TypeText = Localize.GetString("USERTABLE_TYPE_DATETIME", "Date",null);
			tableTypes[3].TypeValue = "DateTime";	
			tableTypes[4] = new UserDefinedTableType();
			tableTypes[4].TypeText = Localize.GetString("USERTABLE_TYPE_BOOLEAN", "True/False",null);
			tableTypes[4].TypeValue = "Boolean";	
			tableTypes[5] = new UserDefinedTableType();
			tableTypes[5].TypeText = Localize.GetString("USERTABLE_TYPE_FILE", "File",null);
			tableTypes[5].TypeValue = "File";	
			tableTypes[6] = new UserDefinedTableType();
			tableTypes[6].TypeText = Localize.GetString("USERTABLE_TYPE_IMAGE", "Image",null);
