...
namespace Rainbow.DesktopModules
{
	...
	public class Discussion : PortalModuleControl 
	{
		...
		protected void OnItemDataBound(object sender, DataListItemEventArgs e)
		{
			...
			if (e.Item.FindControl("deleteBtn") != null)
			{
				((ImageButton)e.Item.FindControl("deleteBtn")).Attributes.Add("onClick", "return confirm('" + 
					Localize.GetString ("DISCUSSION_DELETE_RESPONSE", "Are you sure you want to delete the selected response message and ALL of its children ?") + "');");
				
				((ImageButton)e.Item.FindControl("deleteBtn")).Attributes.Add("title", Localize.GetString ("DELETE", "Delete this thread"));
			}
			if (e.Item.FindControl("deleteBtnExpanded") != null)
			{
				...
				((ImageButton)e.Item.FindControl("deleteBtnExpanded")).Attributes.Add("title", Localize.GetString ("DELETE", "Delete this thread"));
			}
			...
			if (e.Item.FindControl("Label4") != null)
			{
				...
				{
					((Label)e.Item.FindControl("Label4")).Text = Localize.GetString ("UNKNOWN", "unknown");
				}
			}
			if (e.Item.FindControl("Label10") != null)
			{
				...
				{
					((Label)e.Item.FindControl("Label10")).Text = Localize.GetString ("UNKNOWN", "unknown");
				}
			}
			if (e.Item.FindControl("Label6") != null)
			{
				((Label)e.Item.FindControl("Label6")).ToolTip = Localize.GetString ("DISCUSSION_REPLYS", "Number of replys to this topic");
			}
			if (e.Item.FindControl("Label5") != null)
			{
				((Label)e.Item.FindControl("Label5")).ToolTip = Localize.GetString ("DISCUSSION_VIEWED", "Number of times this topic has been viewed");
			}
			if (e.Item.FindControl("Label1") != null)
			{
				((Label)e.Item.FindControl("Label1")).ToolTip = Localize.GetString ("DISCUSSION_REPLYS", "Number of replys to this topic");
			}
			if (e.Item.FindControl("Label2") != null)
			{
				((Label)e.Item.FindControl("Label2")).ToolTip = Localize.GetString ("DISCUSSION_VIEWED", "Number of times this topic has been viewed");
			}
			if (e.Item.FindControl("btnCollapse") != null)
			{
				((ImageButton)e.Item.FindControl("btnCollapse")).ToolTip = Localize.GetString ("DISCUSSION_MSGCOLLAPSE", "Collapse the thread of this topic");
			}
			if (e.Item.FindControl("btnSelect") != null)
			{
				((ImageButton)e.Item.FindControl("btnSelect")).ToolTip = Localize.GetString ("DISCUSSION_MSGEXPAND", "Expand the thread of this topic inside this browser page");
			}
			if (e.Item.FindControl("btnNewWindow") != null)
			{
				((ImageButton)e.Item.FindControl("btnNewWindow")).ToolTip = Localize.GetString ("DISCUSSION_MSGSELECT", "Open the thread of this topic in a new browser page");
			}
			...
			{
				((HyperLink)e.Item.FindControl("HyperLink2")).Attributes.Add("title" , Localize.GetString ("DS_REPLYTHISMSG", "Reply to this message"));
			}

			if (e.Item.FindControl("HyperLink1") != null)
			{
				((HyperLink)e.Item.FindControl("HyperLink1")).ToolTip = Localize.GetString ("EDIT", "Edit this message");
			}
		...
		{
			SearchDefinition s = new SearchDefinition("rb_Discussion", "Title", "Body", "CreatedByUser", "CreatedDate", searchField);
