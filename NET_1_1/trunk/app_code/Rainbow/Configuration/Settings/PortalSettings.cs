...
namespace Rainbow.Configuration
{
	...
	public class PortalSettings
	{
		...
		public PortalSettings(int pageID, string portalAlias)
		{
			...
			using (SqlConnection myConnection = Config.SqlConnectionString)
			{
				using (SqlCommand myCommand = new SqlCommand("rb_GetPortalSettings", myConnection))
				{
					...
					SqlParameter parameterPageName = new SqlParameter("@TabName", SqlDbType.NVarChar, 50);
					parameterPageName.Direction = ParameterDirection.Output;
					myCommand.Parameters.Add(parameterPageName);
					SqlParameter parameterPageOrder = new SqlParameter("@TabOrder", SqlDbType.Int, 4);
					...
					SqlParameter parameterMobilePageName = new SqlParameter("@MobileTabName", SqlDbType.NVarChar, 50);
					...
					try
					{
						...
						while (result.Read())
						{
							...
							tabDetails.PageID = (int) result["TabID"];
							tabDetails.ParentPageID = Int32.Parse("0" + result["ParentTabID"]);
							tabDetails.PageName = (string) result["TabName"];
							tabDetails.PageOrder = (int) result["TabOrder"];
						...
						while (result.Read())
						{
							PageStripDetails tabDetails = new PageStripDetails();
							tabDetails.PageID = (int) result["TabID"];
							tabDetails.PageName = (string) result["MobileTabName"];
							tabDetails.PageLayout = this.CurrentLayout;
							tabDetails.AuthorizedRoles = (string) result["AuthorizedRoles"];
		...
		/// 
		/// </summary>
		/// <param name="requiredTheme"></param>
		/// <returns></returns>
...
//		}
		...
		public static Hashtable GetPortalBaseSettings(string PortalPath)
		{
			...
			if (!CurrentCache.Exists(Key.PortalBaseSettings()))
			{
				...
				catch (NullReferenceException ex)
				{
					...
					ErrorHandler.Publish(LogLevel.Error, "Failed to create 'CountriesFilter' in PortalSettings.", ex); // Jes1111
				}
				...
				*/
				...
				// mgregory@gt.com.au : This must be changed manually when upgrading a db
				...
				//CacheDependency settingDependancies = new CacheDependency(null, new string[]{Rainbow.Settings.Cache.Key.ThemeList(ThemeManager.Path)});
		...
		public static Hashtable GetPortalCustomSettings(int portalID, Hashtable _baseSettings)
		{
			if (!CurrentCache.Exists(Key.PortalSettings()))
			{
				...
				//Rainbow.Settings.Cache.CurrentCache.Insert(Rainbow.Settings.Cache.Key.PortalSettings(), _baseSettings);
				CacheDependency settingDependencies =
					new CacheDependency(
						null,
						new string[]
		...
		public static string GetStringResource(string resourceID)
		{
			...
			{
				//Rainbow.Helpers.LogHelper.Logger.Log(Rainbow.Configuration.LogLevel.Debug, "Resource not found: " + resourceID, ex);
			...
			if (!CurrentCache.Exists(Key.LanguageList()))
			{
				...
				using (SqlConnection myConnection = Config.SqlConnectionString)
				{
					using (SqlCommand myCommand = new SqlCommand("rb_GetPortalSettingsLangList", myConnection))
					{
						...
						{
							// Rainbow.Helpers.LogHelper.Logger.Log(Rainbow.Configuration.LogLevel.Warn, "Get languages from db", ex);
		...
		public bool AllowEditUserID
		{
			get
			{
				return (CustomSettings["SITESETTINGS_ALLOW_EDIT_USER_ID"] == null) ? false : bool.Parse(CustomSettings["SITESETTINGS_ALLOW_EDIT_USER_ID"].ToString());
			}
		}
...
//		}
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.ADUserName")]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.ADUserPassword")]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.EncryptPassword")]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Portal.CodeVersion")]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Database.DatabaseVersion", false)]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.EnableADUser")]
		...
		/// </summary>
		[Obsolete("Use Rainbow.Settings.Portal.UniqueID")]
		...
		/// Obsolete
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.EnableMonitoring")]
		...
		/// Database connection
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.SqlConnectionString")]
		...
		/// </summary>
		[Obsolete("Please use Rainbow.Settings.Config.UseSingleUserBase")]
...
//	/// <summary>
//	/// This is a temporary class to support DesktopPagesXml.
//	/// Since PortalSettings.DesktopPage is not directly serializable,
//	/// GetDesktopPagesXml uses this class to get the job done.
//	/// 
//	/// </summary>
//	/// <remarks>
//	/// Jes1111
...
//		///     
//		/// </remarks>
//		[XmlElement(ElementName="MenuGroup")] public object PagesBox;
//	}
