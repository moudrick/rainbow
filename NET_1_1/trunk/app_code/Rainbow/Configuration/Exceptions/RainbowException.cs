...
namespace Rainbow.Configuration
{
	...
	public class RainbowException : Exception
	{
		...
		public RainbowException(string message) : base(message)
		{
		}
		...
		public RainbowException(string message, Exception inner) : base(message, inner)
		{
		}
		...
		/// <param name="message">Text message to be included in log.</param>
		/// <param name="inner">Inner exception</param>
		public RainbowException(LogLevel level, string message, Exception inner) : base(message, inner)
		{
			_level = level;
		}
		...
		/// <param name="message">Text message to be included in log.</param>
		/// <param name="inner">Inner exception</param>
		public RainbowException(LogLevel level, HttpStatusCode statusCode, string message, Exception inner) : base(message, inner)
		{
			_level = level;
		...
		protected RainbowException(SerializationInfo info, StreamingContext context) : base(info,context)
		{
