...
//
//			if (!Rainbow.Settings.Cache.CurrentCache.Exists (Rainbow.Settings.Cache.Key.LayoutList(PortalLayoutPath)))
//			{
//				//Initialize array
...
//				}
//		
//				Rainbow.Settings.Cache.CurrentCache.Insert (Rainbow.Settings.Cache.Key.LayoutList(PortalLayoutPath), layoutsList);
//			}
//			else
//			{
//				layoutsList = (ArrayList) Rainbow.Settings.Cache.CurrentCache.Get (Rainbow.Settings.Cache.Key.LayoutList(PortalLayoutPath));
//			}
//			return layoutsList;
...
//			return LayoutManager.cachedLayoutsList;
		...
		public ArrayList GetPrivateLayouts()
		{
			...
			if ( !CurrentCache.Exists(Key.LayoutList(this.PortalLayoutPath)) )
			{
				...
				CurrentCache.Insert(Key.LayoutList(PortalLayoutPath), privateLayoutList, new CacheDependency(PortalLayoutPath));
			}
			else
			{
