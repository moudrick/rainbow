...
namespace Rainbow
{
	...
	public class HttpUrlBuilder
	{
		...
		/// <param name="currentAlias">Current Alias</param> 
		/// <param name="urlKeywords">Add some keywords to uniquely identify this tab. Usual source is UrlKeyword from TabSettings.</param> 
		public static string BuildUrl(string targetPage, int pageID, int modID, CultureInfo culture, string customAttributes, string currentAlias, string urlKeywords)
		{
			...
			*/
			...
			return provider.BuildUrl( targetPage, pageID, modID, culture, completeCustomAttributes, currentAlias, urlKeywords);	
		}
