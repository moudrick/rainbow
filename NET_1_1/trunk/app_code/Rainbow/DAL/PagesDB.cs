...
namespace Rainbow.Configuration
{
	...
	public class PagesDB
	{
		...
		/// <returns></returns>
		public int AddPage(int portalID, int parentPageID, string pageName, int pageOrder, string authorizedRoles, bool showMobile, string mobilePageName) 
		{
			...
			using (SqlConnection myConnection = Config.SqlConnectionString)
			{
				...
				using (SqlCommand myCommand = new SqlCommand("rb_AddTab", myConnection))
				{
					...
					if (pageName == null || pageName.Length == 0) pageName = "New Tab";
		...
		/// <param name="mobilePageName"></param>
		/// <param name="showMobile"></param>
		public void UpdatePage (int portalID, int pageID, int parentPageID, string pageName, int pageOrder, string authorizedRoles, string mobilePageName, bool showMobile) 
		{
		...
		{
			string strSQL="select TabOrder from rb_Tabs Where (PortalID = " + portalID.ToString() + ") AND (TabID = " + pageID.ToString() + ")";
			int t_order = 99990;
			// Read the resultset
