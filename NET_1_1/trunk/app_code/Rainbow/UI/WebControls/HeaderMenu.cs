...
//			return sb.ToString();
			...
			string helpText = Localize.GetString("HEADER_HELP", "Help");
		...
		public override void DataBind()
		{
			if(HttpContext.Current != null)
			{
				...
				homeLink = homeLink + " href='" + HttpUrlBuilder.BuildUrl() + "'>" + 
					Localize.GetString("HOME", "Home", this) + "</a>";
				...
				if (HttpContext.Current.Request.IsAuthenticated == true) 
				{
					if (ShowWelcome)
					{
						list.Add(Localize.GetString("HEADER_WELCOME", "Welcome", this) + "&#160;" + PortalSettings.CurrentUser.Identity.Name + "!");
					}
...
//						TabModuleID=(int)result["ModuleId"];
					...
					if ((ShowTabMan) && (HasEditPermissionsOnTabs))
					{
						...
						menuLink = menuLink + " href='" + HttpUrlBuilder.BuildUrl("~/DesktopModules/Pages/PageLayout.aspx?PageID=") + 
							...
							Localize.GetString("HEADER_MANAGE_TAB", "Edit This Page", null) + "</a>";
						list.Add(menuLink); 
					}
					...
					{	
						...
						{	
							...
							menuLink = menuLink + " href='" + HttpUrlBuilder.BuildUrl("~/DesktopModules/Register/Register.aspx", "userName=" + 
								...
								Localize.GetString("HEADER_EDIT_PROFILE", "Edit profile", this) + "</a>";
							list.Add(menuLink); 
						}
					}
					...
					if (Context.User.Identity.AuthenticationType == "Forms" || Context.User.Identity.AuthenticationType == "LDAP") 
					{
						if (ShowLogOff)
						{
							...
							menuLink = menuLink + " href='" + href + "'>" + Localize.GetString("HEADER_LOGOFF", "Logoff", null) + "</a>";
							list.Add(menuLink); 
						}
					}
...
//						GlobalResources.SupportWindowMgmt ) 
					if ( lb != null && HttpContext.Current.Request.IsAuthenticated && Config.WindowMgmtControls ) 
						...
						if(ShowSaveDesktop)
						{
							...
							menuLink = menuLink + " href=\"javascript:__doPostBack('" + lb_id + "','')\">" + 
								Localize.GetString("HEADER_SAVE_DESKTOP", "Save Desktop",null) + "</a>";
							list.Add(menuLink); 
						}
					}
					// [END] bja@reedtek.com
				...
				else 
				{
					...
					if (ShowLogon) 
					{
						...
						menuLink = menuLink + " href='" + HttpUrlBuilder.BuildUrl("~/DesktopModules/Admin/Logon.aspx") + "'>" + Localize.GetString("LOGON", "Logon", null) + "</a>"; 
						list.Add(menuLink); 
					}
					...
					if (ShowSecureLogon) 
					{
						...
						menuLink = menuLink + " href='" + portalSettings.PortalSecurePath + "/Logon.aspx'>" + 
							Localize.GetString("LOGON", "Logon", null) + "</a>";
						list.Add(menuLink); 
					}
				}
