...
{ 
	...
	{ 
		...
		private void AddShopHomeNode() 
		{
			...
			MenuTreeNode mn = new MenuTreeNode(Localize.GetString("PRODUCT_HOME", "Shop Home"));
		...
		{ 
			...
			{ 
				...
				mn.Link = HttpUrlBuilder.BuildUrl("~/" + HttpUrlBuilder.DefaultPage, tabIDShop, "ItemID=" + myTab.PageID);
				mn.Width = Width; 
			...
			{ 
				...
				{ 
					...
					{ 
						...
						mnc.Link = HttpUrlBuilder.BuildUrl("~/" + HttpUrlBuilder.DefaultPage, tabIDShop, "ItemID=" + mySubTab.PageID);
						mnc.Width = mn.Width; 
