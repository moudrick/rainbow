...
namespace Rainbow.UI.WebControls
{
	...
	[
		DefaultProperty("Title"),
			...
			Designer("Rainbow.UI.Design.DesktopModuleTitleDesigner")
	]
	public class DesktopModuleTitle : Control // WebControl - only needs generic Control now
	{
		...
		private string _PropertiesUrl = "~/DesktopModules/Admin/PropertyPage.aspx";
		...
		private string _SecurityUrl = "~/DesktopModules/Admin/ModuleSettings.aspx";
