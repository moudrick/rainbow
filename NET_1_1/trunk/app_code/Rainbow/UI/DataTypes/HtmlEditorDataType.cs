	...
	public class HtmlEditorDataType : ListDataType
	{
		...
		public static void HtmlEditorSettings (Hashtable editorSettings, SettingItemGroup group) 
		{
			...
			if (pS != null)
			{
				...
				{
					ModuleImageFolder = new SettingItem(new FolderDataType(HttpContext.Current.Server.MapPath(pS.PortalFullPath + "/images"), "default"));
		...
		public override object DataSource
		{
			get
			{
				return "Plain Text;FCKEditor;FCKEditor V2;FreeTextBox;ActiveUp HtmlTextBox".Split(';');
			}
		}
...
//					fckv2.EditorAreaCSS = portalSettings.GetCurrentTheme().CssFile;
					...
					fckv2.ImageBrowserURL = Path.WebPathCombine(Path.ApplicationRoot, "aspnet_client/FCKEditorV2/editor/filemanager/browser.html?Type=Image&Connector=" + conector);
					fckv2.LinkBrowserURL = Path.WebPathCombine(Path.ApplicationRoot, "aspnet_client/FCKEditorV2/editor/filemanager/browser.html?Connector=" + conector);
				...
				case "FreeTextBox":
					...
					freeText.ImageGalleryUrl = Path.WebPathCombine(Path.ApplicationFullPath, "app_support/ftb.imagegallery.aspx?rif={0}&cif={0}&mID=" + moduleID.ToString());
				...
				case "ActiveUp HtmlTextBox" :
					...
					imageLibrary.Directories.Add("images", HttpContext.Current.Server.MapPath(portalSettings.PortalFullPath + h.ImageFolder), portalSettings.PortalFullPath + h.ImageFolder + "/");
