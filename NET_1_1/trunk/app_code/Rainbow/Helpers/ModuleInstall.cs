	...
	public class ModuleInstall
	{
		...
		public static void Install(string friendlyName, string desktopSource, string mobileSource, bool install)
		{
			...
			if (install) 
			{
				...
				{
					//Rethrow exception
					throw new Exception("AddGeneralModuleDefinitions Exception '" + portalModule.GuidID.ToString() + "'!", ex);
				}
			...
			else 
			{
				...
				{
					//Rethrow exception
					throw new Exception("UpdateGeneralModuleDefinitions Exception '" + portalModule.GuidID.ToString() + "'!", ex);
				}
			}
