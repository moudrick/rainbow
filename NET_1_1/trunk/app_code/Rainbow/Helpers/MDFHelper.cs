	...
	public class MDFSettings
	{
		...
		public bool Populate(PortalModuleControl pmc, string itemTableName, string titleFieldName, string selectFieldList, string searchFieldList)
		{
			...
			try
			{
				...
				SqlDataReader dr = u.GetSingleUser(PortalSettings.CurrentUser.Identity.Email, _portalID);
				if(dr.Read())
		...
		public SqlDataReader GetDataReader()
		{
			...
			return Helpers.DBHelper.GetDataReader(sqlSelect);
		}
		...
		{
			string sqlSelect = GetSqlSelect();
			return Helpers.DBHelper.GetDataSet(sqlSelect);
		}
	}
