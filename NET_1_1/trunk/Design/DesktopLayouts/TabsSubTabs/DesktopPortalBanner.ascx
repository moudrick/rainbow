    ...
    <tbody>
                ...
                <table cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <td valign="top">
                                <CC1:HEADERMENU id="PortalHeaderMenu" runat="server" CssClass="SiteLink" ShowHelp="True" RepeatDirection="Horizontal" CellPadding="4" ShowHome="False">
        ...
        <tr>
            <td class="DefaultTD" colspan="2">
                <CC1:DESKTOPNAVIGATION id="PortalTabs" runat="server" EnableViewState="false" HorizontalAlign="left" repeatdirection="horizontal">
        ...
        <tr>
            <td class="DefaultTDSub" colspan="2">
                <CC1:DESKTOPNAVIGATION id="PortalSubTabs" runat="server" EnableViewState="false" HorizontalAlign="left" repeatdirection="horizontal" Bind="BindOptionSubtabSibling">
                    <ITEMSTYLE cssclass="SubTabs"></ITEMSTYLE>
                    <ITEMTEMPLATE>
                        <a href="<%#Rainbow.HttpUrlBuilder.BuildUrl(((Rainbow.Configuration.PageStripDetails) Container.DataItem).PageID)%>"><%# ((Rainbow.Configuration.PageStripDetails) Container.DataItem).PageName %></a>
                    </ITEMTEMPLATE>
                    <SELECTEDITEMSTYLE cssclass="SelectedSubTabs"></SELECTEDITEMSTYLE>
                    <SELECTEDITEMTEMPLATE>
                        <a href="<%#Rainbow.HttpUrlBuilder.BuildUrl(((Rainbow.Configuration.PageStripDetails) Container.DataItem).PageID)%>"><%# ((Rainbow.Configuration.PageStripDetails) Container.DataItem).PageName %></a>
                    </SELECTEDITEMTEMPLATE>
                </CC1:DESKTOPNAVIGATION>
