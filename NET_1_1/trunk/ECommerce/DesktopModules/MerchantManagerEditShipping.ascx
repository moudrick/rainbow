<%@ Control Language="c#" AutoEventWireup="false" Codebehind="MerchantManagerEditShipping.ascx.cs" Inherits="Rainbow.ECommerce.MerchantManagerEditShipping" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
