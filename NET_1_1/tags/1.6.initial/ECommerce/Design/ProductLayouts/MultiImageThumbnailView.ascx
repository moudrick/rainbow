...
<table cellSpacing="0" cellPadding="4" border="0">
	<TBODY>
		...
		<tr>
			...
			<td vAlign="top">
				<product:ProductImageGoToDetails ProductID='<%# ProductID %>' ImageUrl='<%# GetMetadata("ShopPath") + "/" + GetMetadata("ThumbnailFilename")%>' runat="server" Text='<%#GetMetadata("ModelName")%>' width='<%#Unit.Parse("0" + GetMetadata("ThumbnailWidth")+ "px")%>' height='<%#Unit.Parse("0" + GetMetadata("ThumbnailHeight")+ "px")%>' id=ProductImageGoToDetails1>
