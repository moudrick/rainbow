...
namespace Rainbow.DesktopModules.Milestones
{
	...
	public class Milestones : PortalModuleControl
	{
		...
		private void Page_Load(object sender, EventArgs e)
		{
			...
			foreach (DataGridColumn column in myDataGrid.Columns)
			{
				...
				{
					case 1:
						column.HeaderText = Localize.GetString("MILESTONES_TITLE");
						break;
					case 2:
						column.HeaderText = Localize.GetString("MILESTONES_COMPLETION_DATE");
						break;
					case 3:
						column.HeaderText = Localize.GetString("MILESTONES_STATUS");
						break;
				}
			}
		...
		public override string SearchSqlSelect(int portalID, int userID, string searchString, string searchField)
		{
			...
			SearchDefinition s = new SearchDefinition("rb_Milestones", "Title", "Status", "CreatedByUser", "CreatedDate", searchField);
