...
namespace Rainbow.DesktopModules 
{
	...
	public class EventsEdit	: AddEditItemPage
	{
		#region Declarations
		/// <summary>
		/// 
		...
		/// 
		/// </summary>
		protected RequiredFieldValidator	RequiredWhereWhen;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected RadioButtonList	AllDay;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected DropDownList StartHour;
		/// <summary>
		/// 
		/// </summary>
		protected DropDownList StartMinute;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		protected DropDownList StartAMPM;
		...
		private	void Page_Load(object sender, EventArgs e) 
		{
			...
			foreach(ListItem item in AllDay.Items )
			{
				...
				{         
					case 0:
						item.Text = Localize.GetString ("EVENTS_ALLDAY");
						break;
					case 1:
						item.Text = Localize.GetString("EVENTS_STARTAT");
						break;
				}
			}
		...
		{
			//Translate
			RequiredTitle.ErrorMessage = Localize.GetString("EVENTS_VALID_TITLE");
			// RequiredDescription.ErrorMessage = Esperantus.Localize.GetString("EVENTS_VALID_DESCRIPTION");
			RequiredWhereWhen.ErrorMessage = Localize.GetString("EVENTS_VALID_WHERE-WHEN");
			RequiredExpireDate.ErrorMessage	= Localize.GetString("EVENTS_VALID_EXPIRE");
			VerifyExpireDate.ErrorMessage =	Localize.GetString("EVENTS_VALID_EXPIRE");
		...
		{
			this.AllDay.SelectedIndexChanged += new EventHandler(this.AllDay_SelectedIndexChanged);
