...
namespace Rainbow.Configuration
{
	...
	public sealed class CodeVersionException : Exception
	{
		...
		public CodeVersionException(string message) : base(message)
		{
		}
		...
		public CodeVersionException(string message, Exception inner) : base(message, inner)
		{
		}
	}
}