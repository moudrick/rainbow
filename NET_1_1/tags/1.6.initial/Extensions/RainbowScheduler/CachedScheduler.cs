...
namespace Rainbow
{
	namespace Scheduler
	{
		...
		public class CachedScheduler : SimpleScheduler
		{
			...
			/// <returns></returns>
			public static CachedScheduler GetScheduler(string applicationMapPath, IDbConnection connection, long period, int cacheSize)
			{
				//Sigleton
			...
			protected CachedScheduler(string applicationMapPath, IDbConnection connection, long period, int cacheSize) : base(applicationMapPath, connection, period)
			{
