...
namespace Rainbow.Core
{
	...
	#region Interface IPageCollection

	/// <summary>
	/// Defines size, enumerators, and synchronization methods for strongly
	/// typed collections of <see cref="Page"/> elements.
	/// </summary>
	/// <remarks>
	/// <b>IPageCollection</b> 
	/// provides an <see cref="ICollection"/> that is strongly typed for 
	/// <see cref="Page"/> elements.
	/// </remarks>
	public interface IPageCollection
	{
		...
		/// <summary>
		/// Copies the entire <see cref="IPageCollection"/> 
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Page"/> elements, 
		/// starting at the specified index of the target array.
		/// </summary>
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination 
		/// of the <see cref="Page"/> elements copied 
		/// from the <see cref="IPageCollection"/>.
		...
		/// <see cref="IPageCollection"/> is greater
		...
		/// </remarks>
		void CopyTo(Page[] array, int arrayIndex);
		...
		/// <summary>
		/// Returns an <see cref="IPageEnumerator"/> that can
		/// iterate through the <see cref="IPageCollection"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IPageEnumerator"/> for the entire 
		/// <see cref="IPageCollection"/>.</returns>
		/// <remarks>
		/// Please refer to 
		/// <see cref="IEnumerable.GetEnumerator"/> for details.
		/// </remarks>
		IPageEnumerator GetEnumerator();
	...
	#region Interface IPageList

	/// <summary>
	/// Represents a strongly typed collection 
	/// of <see cref="Page"/> objects 
		...
		IPageList : IPageCollection
	{
		...
		/// <see cref="IPageList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IPageList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the 
		/// <see cref="IPageList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IPageList"/> 
		...
		/// </summary>
		/// <param name="index">
		/// The zero-based index of the <see cref="Page"/> 
		/// element to get or set.</param>
		/// <value>
		/// The <see cref="Page"/> element 
		...
		/// <see cref="IPageCollection.Count"/>.</para>
		/// </exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the 
		/// <see cref="IPageList"/> is read-only.</exception>
		/// <remarks>
		/// Please refer to <see cref="IList.this"/> for details.
		/// </remarks>
		Page this[int index] { get; set; }
		...
		/// <summary>
		/// Adds a <see cref="Page"/> to the end 
		/// of the <see cref="IPageList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to be added 
		/// to the end of the <see cref="IPageList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="IPageList"/> index at which 
		/// the <paramref name="value"/> has been added.</returns>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IPageList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The <b>IPageList</b> has a fixed size.
		/// </para></exception>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="IPageList"/>
		/// contains the specified <see cref="Page"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to locate 
		/// in the <see cref="IPageList"/>.
		/// </param>
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="IPageList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		/// Please refer to <see cref="IList.Contains"/> for details.
		/// </remarks>
		bool Contains(Page value);
		...
		/// of the specified <see cref="Page"/> 
		/// in the <see cref="IPageList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to locate 
		...
		/// <paramref name="value"/> in the <see cref="IPageList"/>, 
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		/// Please refer to <see cref="IList.IndexOf"/> for details.
		/// </remarks>
		int IndexOf(Page value);
		...
		/// <summary>
		/// Inserts a <see cref="Page"/> element into the
		/// <see cref="IPageList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		/// The zero-based index at which 
		/// <paramref name="value"/> should be inserted.</param>
		/// <param name="value">
		/// The <see cref="Page"/> object to insert 
		/// into the <see cref="IPageList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		...
		/// </remarks>
		void Insert(int index, Page value);
		...
		/// <see cref="Page"/> from the 
		/// <see cref="IPageList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to remove 
		/// from the <see cref="IPageList"/>.
		/// </param>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IPageList"/> is read-only.
		/// </para><para>-or-</para><para>
	...
	#region Interface IPageEnumerator
	...
	public interface IPageEnumerator
	{
		...
		/// <summary>
		/// Gets the current <see cref="Page"/> 
	...
	/// <see cref="Page"/> elements.
	/// </para><para>
	/// The <see cref="Page.Id"/> property
	/// of the <see cref="Page"/> class can be used as a key
	/// to locate elements in the <b>PageArrayList</b>.
	/// </para><para>
	...
	/// current value of the <see cref="PageArrayList.Count"/> property.
	/// </para></remarks>
	[Serializable]
	public class PageArrayList : IPageList, IList, ICloneable
	{
		...
		/// </remarks>
		private PageArrayList(Data data)
		{
			//
		...
		public PageArrayList()
		{
			...
			//
			_data = new Data();
			_data.Items = new Page[Data.DefaultCapacity];
		}

		#endregion

		#region PageArrayList(Int32)
		...
		/// <see cref="PageArrayList"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="capacity"/> is less than zero.</exception>
		/// <remarks>
		/// Please refer to <see cref="ArrayList(Int32)"/> for details.
		/// </remarks>
		public PageArrayList(int capacity)
		{
			//
			// TODO: Add any constructor code after InitializeComponent call
			//
			...
			_data = new Data();
			_data.Items = new Page[capacity];
		}

		#endregion

		#region PageArrayList(PageArrayList)

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="PageArrayList"/> class that
		...
		/// </remarks>
		public PageArrayList(PageArrayList collection)
		{
			//
			// TODO: Add any constructor code after InitializeComponent call
			//
		...
		/// Please refer to <see cref="ArrayList(ICollection)"/> for details.
		/// </remarks>
		public PageArrayList(Page[] array)
		{
			//
			// TODO: Add any constructor code after InitializeComponent call
			//
			...
			_data = new Data();
			_data.Items = new Page[array.Length];
		...
		/// <summary>
		/// Gets or sets the capacity of the <see cref="PageArrayList"/>.
		/// </summary>
		/// <value>
		/// The number of elements that the
		/// <see cref="PageArrayList"/> can contain.
		/// </value>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <b>Capacity</b> is set to a value that is
		/// less than <see cref="Count"/>.</exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the <see cref="PageArrayList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="PageArrayList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="PageArrayList"/>
		/// has a fixed size; otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="PageArrayList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="PageArrayList"/>
		/// is read-only; otherwise, <c>false</c>.
		...
		/// <summary>
		/// Gets a value indicating whether access to the
		/// <see cref="PageArrayList"/> is synchronized (thread-safe).
		/// </summary>
		/// <value>
		/// <c>true</c> if access to the <see cref="PageArrayList"/>
		/// is synchronized (thread-safe); otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <see cref="PageArrayList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The property is set, the <b>PageArrayList</b>
		/// already contains the specified element at a different index,
		/// and the <b>PageArrayList</b> ensures
		...
		/// <summary>
		/// Adds a <see cref="Page"/> to the end
		/// of the <see cref="PageArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to be added
		/// to the end of the <see cref="PageArrayList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="PageArrayList"/>
		...
		/// <see cref="PageArrayList"/>. This argument
		/// must be compatible with <see cref="Page"/>.
		/// </param>
		/// <returns>
		/// The <see cref="PageArrayList"/>
		/// index at which the <paramref name="value"/> has been added.
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="PageArrayList"/> whose elements
		...
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>PageArrayList</b> already contains one
		...
		/// </remarks>
		public virtual void AddRange(PageArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		#region AddRange(Page[])

		/// <summary>
		/// Adds the elements of a <see cref="Page"/> array
		/// to the end of the <see cref="PageArrayList"/>.
		/// </summary>
		/// <param name="array">
		/// An <see cref="Array"/> of <see cref="Page"/>
		/// elements that should be added to the end of the
		/// <see cref="PageArrayList"/>.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="PageArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>PageArrayList</b> already contains
		...
		/// Please refer to <see cref="ArrayList.AddRange"/> for details.
		/// </remarks>
		public virtual void AddRange(Page[] array)
		{
			if (array == null)
				throw new ArgumentNullException("array");
		...
		#region BinarySearch(Page)

		/// <summary>
		/// Searches the entire sorted <see cref="PageArrayList"/>
		/// for an <see cref="Page"/> element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to locate
		/// in the <see cref="PageArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of <paramref name="value"/> in the sorted
		/// <see cref="PageArrayList"/>, if <paramref name="value"/>
		...
		/// </remarks>
		public int BinarySearch(Page value)
		{
			if (_data.Count == 0) return ~0;

			int index, left = 0, right = _data.Count - 1;
			Page[] items = _data.Items;

			do
			{
				index = (left + right)/2;
				Page current = items[index];
		...
		#region BinarySearch(Page, IComparer)

		/// <overloads>
		/// Uses a binary search algorithm to locate a specific element
		/// in the sorted <see cref="PageArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Searches the entire sorted <see cref="PageArrayList"/>
		...
		#region BinarySearch(Int32, Int32, Page, IComparer)

		/// <summary>
		/// Searches a section of the sorted
		/// <see cref="PageArrayList"/> for an
		/// <see cref="Page"/> element using the
		/// specified comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="index">
		...
		/// <summary>
		/// Removes all elements from the <see cref="PageArrayList"/>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PageArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <summary>
		/// Creates a shallow copy of the <see cref="PageArrayList"/>.
		/// </summary>
		/// <returns>
		/// A shallow copy of the <see cref="PageArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		#region Contains(Page)

		/// <summary>
		/// Determines whether the <see cref="PageArrayList"/>
		/// contains the specified <see cref="Page"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object to locate
		...
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="PageArrayList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="PageArrayList"/> contains
		/// the specified <see cref="Page.Id"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Page.Id"/> value to locate
		/// in the <see cref="PageArrayList"/>.
		...
		/// of the <see cref="Page.Id"/> property
		/// of each <see cref="Page"/> element, rather than
		...
		/// <summary>
		/// Creates a deep copy of the <see cref="PageArrayList"/>.
		/// </summary>
		/// <returns>
		/// A deep copy of the <see cref="PageArrayList"/>.
		/// </returns>
		/// <remarks><para>
		/// <b>Copy</b> has the same effect as <see cref="Clone"/>
		/// because <see cref="Page"/> is a value type.
		/// </para><para>
		/// <b>Copy</b> always returns a <b>PageArrayList</b> 
		...
		/// </para></remarks>
		public PageArrayList Copy()
		{
			int count = _data.Count;
			PageArrayList copy =
				new PageArrayList(count);
		...
		/// <overloads>
		/// Copies the <see cref="PageArrayList"/>
		/// or a portion of it to a one-dimensional array.
		/// </overloads>
		/// <summary>
		/// Copies the entire <see cref="PageArrayList"/>
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Page"/> elements,
		...
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination
		/// of the <see cref="Page"/> elements copied from the
		/// <see cref="PageArrayList"/>.
		/// The <b>Array</b> must have zero-based indexing.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		/// <exception cref="ArgumentException">
		/// The number of elements in the source
		/// <see cref="PageArrayList"/> is greater than
		...
		/// </para><para>-or-</para><para>
		/// The number of elements in the source
		/// <see cref="PageArrayList"/> is greater
		/// than the available space from <paramref name="arrayIndex"/>
		/// to the end of the destination <paramref name="array"/>.
		/// </para></exception>
		/// <remarks>
		...
		#region GetEnumerator: IPageEnumerator

		/// <summary>
		/// Returns an <see cref="IPageEnumerator"/> that can
		/// iterate through the <see cref="PageArrayList"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IPageEnumerator"/> for the entire
		/// <see cref="PageArrayList"/>.
		...
		/// </remarks>
		public IPageEnumerator GetEnumerator()
		{
		...
		/// <summary>
		/// Returns the zero-based index of the first occurrence
		/// of the specified <see cref="Page"/> in the
		/// <see cref="PageArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Page"/> object
		/// to locate in the <see cref="PageArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="PageArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		/// </summary>
		/// <param name="value">
		/// The object to locate in the <see cref="PageArrayList"/>.
		/// This argument must be compatible with <see cref="Page"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="PageArrayList"/>,
		...
		/// specified <see cref="Page.Id"/> value
		/// in the <see cref="PageArrayList"/>.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Page.Id"/> value
		/// to locate in the <see cref="PageArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="key"/> in the <see cref="PageArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		#region Insert(Int32, Page)

		/// <summary>
		/// Inserts a <see cref="Page"/> element into the
		/// <see cref="PageArrayList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		...
		/// <param name="value">
		/// The <see cref="Page"/> object to insert
		/// into the <see cref="PageArrayList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para><para>
		...
		/// </remarks>
		public virtual void Insert(int index, Page value)
		{
			int count = _data.Count;
		...
		/// should be inserted.</param>
		/// <param name="value">
		/// The object to insert into the <see cref="PageArrayList"/>.
		/// This argument must be compatible with <see cref="Page"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		...
		/// is not compatible with <see cref="Page"/>.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="PageArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="PageArrayList"/> to wrap.</param>
		/// <returns>
		...
		/// </remarks>
		public static PageArrayList ReadOnly(
			PageArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		/// <param name="value">
		/// The <see cref="Page"/> object to remove
		/// from the <see cref="PageArrayList"/>.
		/// </param>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PageArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <paramref name="index"/> and <paramref name="count"/>
		/// do not denote a valid range of elements in the
		/// <see cref="PageArrayList"/>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		/// <para><paramref name="count"/> is less than zero.</para>
		...
		/// <see cref="PageArrayList"/> or a portion of it.
		/// </overloads>
		/// <summary>
		...
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PageArrayList"/> is read-only.
		/// </exception>
		/// <remarks>
		...
		/// <overloads>
		/// Sorts the elements in the <see cref="PageArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Sorts the elements in the entire <see cref="PageArrayList"/>
		...
		/// </exception>
		/// <exception cref="InvalidOperationException">
		/// One or more elements in the <see cref="PageArrayList"/>
		...
		/// <see cref="PageArrayList"/> using the specified comparer.
		/// </summary>
		/// <param name="comparer">
		/// <para>The <see cref="IComparer"/> implementation
		/// to use when comparing elements.</para>
		...
		/// <summary>
		/// Copies the elements of the <see cref="PageArrayList"/>
		/// to a new <see cref="Array"/> of
		/// <see cref="Page"/> elements.
		/// </summary>
		/// <returns>
		/// A one-dimensional <see cref="Array"/> of
		/// <see cref="Page"/> elements containing copies of the
		/// elements of the <see cref="PageArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		public Page[] ToArray()
		{
			Page[] array = new Page[_data.Count];
		...
		private void AddRange(Page[] array, int range)
		{
			if (range == 0) return;

			if (_data.IsUnique)
			{
				foreach (Page value in array)
				{
					CheckUnique(value);
				}
			}
		...
		private void CheckUnique(Page value)
		{
			if (IndexOf(value) >= 0)
			{
		...
		private void CheckUnique(Page value, int index)
		{
		...
		private sealed class Data
		{
			...
			public void SetCapacity(int capacity)
			{
				...
				if (capacity == 0)
				{
					Items = new Page[DefaultCapacity];
					return;
				}

				Page[] items = new Page[capacity];
		...
		private sealed class ReadOnlyWrapper : PageArrayList
		{
			...
			public override int Add(Page value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(PageArrayList collection)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(Page[] array)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
			...
			{
				PageArrayList wrapper =
					(PageArrayList) base.Clone();

				return new ReadOnlyWrapper(wrapper._data);
			}

			public override void Insert(int index, Page value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
