...
namespace Rainbow.Core
{
	...
	#region Interface IPortalCollection

	/// <summary>
	/// Defines size, enumerators, and synchronization methods for strongly
	/// typed collections of <see cref="Portal"/> elements.
	/// </summary>
	/// <remarks>
	/// <b>IPortalCollection</b> 
	/// provides an <see cref="ICollection"/> that is strongly typed for 
	/// <see cref="Portal"/> elements.
	/// </remarks>
	public interface IPortalCollection
	{
		#region Properties
		...
		/// <summary>
		/// Copies the entire <see cref="IPortalCollection"/> 
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Portal"/> elements, 
		/// starting at the specified index of the target array.
		/// </summary>
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination 
		/// of the <see cref="Portal"/> elements copied 
		/// from the <see cref="IPortalCollection"/>.
		...
		/// <see cref="IPortalCollection"/> is greater
		...
		/// </remarks>
		void CopyTo(Portal[] array, int arrayIndex);
		...
		/// <summary>
		/// Returns an <see cref="IPortalEnumerator"/> that can
		/// iterate through the <see cref="IPortalCollection"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IPortalEnumerator"/> for the entire 
		/// <see cref="IPortalCollection"/>.</returns>
		/// <remarks>
		/// Please refer to 
		/// <see cref="IEnumerable.GetEnumerator"/> for details.
		/// </remarks>
		IPortalEnumerator GetEnumerator();
	...
	#region Interface IPortalList

	/// <summary>
	/// Represents a strongly typed collection 
	/// of <see cref="Portal"/> objects 
		...
		IPortalList : IPortalCollection
	{
		...
		/// <see cref="IPortalList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IPortalList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the 
		/// <see cref="IPortalList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IPortalList"/> 
		...
		/// <summary>
		/// Gets or sets the <see cref="Portal"/> 
		/// element at the specified index.
		/// </summary>
		/// <param name="index">
		/// The zero-based index of the <see cref="Portal"/> 
		/// element to get or set.</param>
		/// <value>
		/// The <see cref="Portal"/> element 
		...
		/// <see cref="IPortalCollection.Count"/>.</para>
		/// </exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the 
		/// <see cref="IPortalList"/> is read-only.</exception>
		/// <remarks>
		/// Please refer to <see cref="IList.this"/> for details.
		/// </remarks>
		Portal this[int index] { get; set; }
		...
		/// <summary>
		/// Adds a <see cref="Portal"/> to the end 
		/// of the <see cref="IPortalList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to be added 
		/// to the end of the <see cref="IPortalList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The <see cref="IPortalList"/> index at which 
		/// the <paramref name="value"/> has been added.</returns>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IPortalList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The <b>IPortalList</b> has a fixed size.
		/// </para></exception>
		/// <remarks>
		/// Please refer to <see cref="IList.Add"/> for details.
		/// </remarks>
		int Add(Portal value);
		...
		/// <summary>
		/// Determines whether the <see cref="IPortalList"/>
		/// contains the specified <see cref="Portal"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to locate 
		/// in the <see cref="IPortalList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="IPortalList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		/// Please refer to <see cref="IList.Contains"/> for details.
		/// </remarks>
		bool Contains(Portal value);
		...
		/// of the specified <see cref="Portal"/> 
		/// in the <see cref="IPortalList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to locate 
		...
		/// <paramref name="value"/> in the <see cref="IPortalList"/>, 
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		/// Please refer to <see cref="IList.IndexOf"/> for details.
		/// </remarks>
		int IndexOf(Portal value);
		...
		/// <summary>
		/// Inserts a <see cref="Portal"/> element into the
		/// <see cref="IPortalList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		/// The zero-based index at which 
		/// <paramref name="value"/> should be inserted.</param>
		/// <param name="value">
		/// The <see cref="Portal"/> object to insert 
		/// into the <see cref="IPortalList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		...
		/// </remarks>
		void Insert(int index, Portal value);
		...
		/// <see cref="Portal"/> from the 
		/// <see cref="IPortalList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to remove 
		/// from the <see cref="IPortalList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IPortalList"/> is read-only.
	...
	#region Interface IPortalEnumerator
	...
	public interface IPortalEnumerator
	{
		...
		/// <summary>
		/// Gets the current <see cref="Portal"/> 
		/// element in the collection.
		/// </summary>
		/// <value>
		/// The current <see cref="Portal"/> 
	...
	/// <see cref="Portal"/> elements.
	/// </para><para>
	/// The <see cref="Portal.Id"/> property
	/// of the <see cref="Portal"/> class can be used as a key
	/// to locate elements in the <b>PortalArrayList</b>.
	/// </para><para>
	...
	/// current value of the <see cref="PortalArrayList.Count"/> property.
	/// </para></remarks>
	[Serializable]
	public class PortalArrayList :
		IPortalList, IList, ICloneable
	{
		...
		/// <see cref="PortalArrayList"/> class
		...
		/// </remarks>
		private PortalArrayList(Data data)
		{
			_data = data;
		}
		...
		/// </remarks>
		public PortalArrayList()
		{
			_data = new Data();
			_data.Items = new Portal[Data.DefaultCapacity];
		}

		#endregion

		#region PortalArrayList(Int32)
		...
		/// <see cref="PortalArrayList"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="capacity"/> is less than zero.</exception>
		/// <remarks>
		/// Please refer to <see cref="ArrayList(Int32)"/> for details.
		/// </remarks>
		public PortalArrayList(int capacity)
		{
			if (capacity < 0)
			{
			...
			_data = new Data();
			_data.Items = new Portal[capacity];
		}

		#endregion

		#region PortalArrayList(PortalArrayList)

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="PortalArrayList"/> class that
		...
		/// </remarks>
		public PortalArrayList(PortalArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");

			_data = new Data();
			_data.Items = new Portal[collection.Count];
			AddRange(collection._data.Items, collection.Count);
		}

		#endregion

		#region PortalArrayList(Portal[])

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="PortalArrayList"/> class
		/// that contains elements copied from the specified
		/// <see cref="Portal"/> array and that has the
		/// same initial capacity as the number of elements copied.
		/// </summary>
		/// <param name="array">
		/// An <see cref="Array"/> of <see cref="Portal"/>
		...
		/// Please refer to <see cref="ArrayList(ICollection)"/> for details.
		/// </remarks>
		public PortalArrayList(Portal[] array)
		{
			if (array == null)
				throw new ArgumentNullException("array");

			_data = new Data();
			_data.Items = new Portal[array.Length];
		...
		/// <summary>
		/// Gets or sets the capacity of the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <value>
		/// The number of elements that the
		/// <see cref="PortalArrayList"/> can contain.
		/// </value>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <b>Capacity</b> is set to a value that is
		/// less than <see cref="Count"/>.</exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the <see cref="PortalArrayList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="PortalArrayList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="PortalArrayList"/>
		/// has a fixed size; otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="PortalArrayList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="PortalArrayList"/>
		/// is read-only; otherwise, <c>false</c>.
		...
		/// <summary>
		/// Gets a value indicating whether access to the
		/// <see cref="PortalArrayList"/> is synchronized (thread-safe).
		/// </summary>
		/// <value>
		/// <c>true</c> if access to the <see cref="PortalArrayList"/>
		/// is synchronized (thread-safe); otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// with <see cref="Portal"/>.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The property is set, and the
		/// <see cref="PortalArrayList"/> is read-only.
		/// </para><para>-or-</para><para>
		...
		/// <summary>
		/// Adds a <see cref="Portal"/> to the end
		/// of the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to be added
		/// to the end of the <see cref="PortalArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The <see cref="PortalArrayList"/>
		...
		/// <see cref="PortalArrayList"/>. This argument
		/// must be compatible with <see cref="Portal"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The <see cref="PortalArrayList"/>
		...
		{
			return Add((Portal) value);
		}

		#endregion

		#region AddRange(PortalArrayList)
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="PortalArrayList"/> whose elements
		...
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>PortalArrayList</b> already contains one
		...
		/// </remarks>
		public virtual void AddRange(PortalArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		#region AddRange(Portal[])

		/// <summary>
		/// Adds the elements of a <see cref="Portal"/> array
		/// to the end of the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <param name="array">
		/// An <see cref="Array"/> of <see cref="Portal"/>
		/// elements that should be added to the end of the
		/// <see cref="PortalArrayList"/>.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="PortalArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>PortalArrayList</b> already contains
		...
		/// Please refer to <see cref="ArrayList.AddRange"/> for details.
		/// </remarks>
		public virtual void AddRange(Portal[] array)
		{
			if (array == null)
				throw new ArgumentNullException("array");
		...
		#region BinarySearch(Portal)

		/// <summary>
		/// Searches the entire sorted <see cref="PortalArrayList"/>
		/// for an <see cref="Portal"/> element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to locate
		/// in the <see cref="PortalArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of <paramref name="value"/> in the sorted
		/// <see cref="PortalArrayList"/>, if <paramref name="value"/>
		...
		/// <remarks>
		/// Please refer to
		/// <see cref="ArrayList.BinarySearch(Object)"/> for details.
		/// </remarks>
		public int BinarySearch(Portal value)
		{
			if (_data.Count == 0) return ~0;

			int index, left = 0, right = _data.Count - 1;
			Portal[] items = _data.Items;
		...
		#region BinarySearch(Portal, IComparer)

		/// <overloads>
		/// Uses a binary search algorithm to locate a specific element
		/// in the sorted <see cref="PortalArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Searches the entire sorted <see cref="PortalArrayList"/>
		...
		public int BinarySearch(
			Portal value, IComparer comparer)
		{
		...
		#region BinarySearch(Int32, Int32, Portal, IComparer)

		/// <summary>
		/// Searches a section of the sorted
		/// <see cref="PortalArrayList"/> for an
		/// <see cref="Portal"/> element using the
		/// specified comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="index">
		...
		/// <summary>
		/// Removes all elements from the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PortalArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <summary>
		/// Creates a shallow copy of the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <returns>
		/// A shallow copy of the <see cref="PortalArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		{
			PortalArrayList clone =
				new PortalArrayList(_data.Count);
		...
		#region Contains(Portal)

		/// <summary>
		/// Determines whether the <see cref="PortalArrayList"/>
		/// contains the specified <see cref="Portal"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object to locate
		...
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="PortalArrayList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		/// Please refer to <see cref="ArrayList.Contains"/> for details.
		/// </remarks>
		public bool Contains(Portal value)
		{
		...
		/// <summary>
		/// Determines whether the <see cref="PortalArrayList"/> contains
		/// the specified <see cref="Portal.Id"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Portal.Id"/> value to locate
		/// in the <see cref="PortalArrayList"/>.
		/// </param>
		/// <returns>
		...
		/// of the <see cref="Portal.Id"/> property
		/// of each <see cref="Portal"/> element, rather than
		...
		/// <summary>
		/// Creates a deep copy of the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <returns>
		/// A deep copy of the <see cref="PortalArrayList"/>.
		/// </returns>
		/// <remarks><para>
		/// <b>Copy</b> is similar to <see cref="Clone"/> but creates a
		/// deep copy of every <see cref="Portal"/> element in the
		/// <see cref="PortalArrayList"/> by invoking its
		/// <see cref="Portal.Clone"/> method.
		/// </para><para>
		/// <b>Copy</b> always returns a <b>PortalArrayList</b> 
		/// whose <see cref="IsReadOnly"/> and <see cref="IsUnique"/>
		/// properties are <c>false</c>, whereas <see cref="Clone"/>
		/// preserves the values of these properties.
		/// </para></remarks>
		public PortalArrayList Copy()
		{
			int count = _data.Count;
			PortalArrayList copy =
				new PortalArrayList(count);

			Portal[] source = _data.Items;
			Portal[] target = copy._data.Items;

			for (int i = 0; i < count; i++)
			{
				if ((object) source[i] != null)
					target[i] = (Portal) source[i].Clone();
			}

			copy._data.Count = count;
			return copy;
		}

		#endregion

		#region CopyTo(Portal[])

		/// <overloads>
		/// Copies the <see cref="PortalArrayList"/>
		/// or a portion of it to a one-dimensional array.
		/// </overloads>
		/// <summary>
		/// Copies the entire <see cref="PortalArrayList"/>
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Portal"/> elements,
		...
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination
		/// of the <see cref="Portal"/> elements copied from the
		/// <see cref="PortalArrayList"/>.
		/// The <b>Array</b> must have zero-based indexing.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		...
		/// </para><para>-or-</para><para>
		/// The number of elements in the source
		/// <see cref="PortalArrayList"/> is greater
		/// than the available space from <paramref name="arrayIndex"/>
		/// to the end of the destination <paramref name="array"/>.
		/// </para></exception>
		/// <remarks>
		/// Please refer to <see cref="ArrayList.CopyTo"/> for details.
		/// </remarks>
		public void CopyTo(Portal[] array, int arrayIndex)
		{
		...
		/// <summary>
		/// Gets the <see cref="Portal"/> element
		/// associated with the first occurrence of the specified
		/// <see cref="Portal.Id"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Portal.Id"/>
		/// value whose element to get.
		/// </param>
		/// <returns>
		/// The <see cref="Portal"/> element associated
		...
		/// to the value of the <see cref="Portal.Id"/>
		/// property of each <see cref="Portal"/> element,
		/// and returns the first matching element.
		/// </remarks>
		public Portal GetByKey(int key)
		{
		...
		#region GetEnumerator: IPortalEnumerator

		/// <summary>
		/// Returns an <see cref="IPortalEnumerator"/> that can
		/// iterate through the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IPortalEnumerator"/> for the entire
		/// <see cref="PortalArrayList"/>.
		...
		/// </remarks>
		public IPortalEnumerator GetEnumerator()
		{
		...
		#region IndexOf(Portal)

		/// <summary>
		/// Returns the zero-based index of the first occurrence
		/// of the specified <see cref="Portal"/> in the
		/// <see cref="PortalArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Portal"/> object
		/// to locate in the <see cref="PortalArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="PortalArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		/// Please refer to <see cref="ArrayList.IndexOf"/> for details.
		/// </remarks>
		public int IndexOf(Portal value)
		{
			int count = _data.Count;
			Portal[] items = _data.Items;
		...
		/// </summary>
		/// <param name="value">
		/// The object to locate in the <see cref="PortalArrayList"/>.
		/// This argument must be compatible with <see cref="Portal"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		...
		/// specified <see cref="Portal.Id"/> value
		/// in the <see cref="PortalArrayList"/>.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Portal.Id"/> value
		/// to locate in the <see cref="PortalArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="key"/> in the <see cref="PortalArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		#region Insert(Int32, Portal)

		/// <summary>
		/// Inserts a <see cref="Portal"/> element into the
		/// <see cref="PortalArrayList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		...
		/// <param name="value">
		/// The <see cref="Portal"/> object to insert
		/// into the <see cref="PortalArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		...
		/// </remarks>
		public virtual void Insert(int index, Portal value)
		{
			int count = _data.Count;
		...
		/// should be inserted.</param>
		/// <param name="value">
		/// The object to insert into the <see cref="PortalArrayList"/>.
		/// This argument must be compatible with <see cref="Portal"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		...
		/// is not compatible with <see cref="Portal"/>.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="PortalArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="PortalArrayList"/> to wrap.</param>
		/// <returns>
		...
		/// </remarks>
		public static PortalArrayList ReadOnly(
			PortalArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		/// <param name="value">
		/// The <see cref="Portal"/> object to remove
		/// from the <see cref="PortalArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PortalArrayList"/> 
		...
		/// </remarks>
		public void Remove(Portal value)
		{
		...
		/// <paramref name="index"/> and <paramref name="count"/>
		/// do not denote a valid range of elements in the
		/// <see cref="PortalArrayList"/>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		/// <para><paramref name="count"/> is less than zero.</para>
		...
		/// <see cref="PortalArrayList"/> or a portion of it.
		/// </overloads>
		/// <summary>
		...
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="PortalArrayList"/> is read-only.
		/// </exception>
		/// <remarks>
		...
		/// <overloads>
		/// Sorts the elements in the <see cref="PortalArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Sorts the elements in the entire <see cref="PortalArrayList"/>
		...
		/// </exception>
		/// <exception cref="InvalidOperationException">
		/// One or more elements in the <see cref="PortalArrayList"/>
		...
		/// <see cref="PortalArrayList"/> using the specified comparer.
		/// </summary>
		/// <param name="comparer">
		/// <para>The <see cref="IComparer"/> implementation
		/// to use when comparing elements.</para>
		...
		/// <summary>
		/// Copies the elements of the <see cref="PortalArrayList"/>
		/// to a new <see cref="Array"/> of
		/// <see cref="Portal"/> elements.
		/// </summary>
		/// <returns>
		/// A one-dimensional <see cref="Array"/> of
		/// <see cref="Portal"/> elements containing copies of the
		/// elements of the <see cref="PortalArrayList"/>.
		/// </returns>
		/// <remarks>
		/// Please refer to <see cref="ArrayList.ToArray"/> for details.
		/// </remarks>
		public Portal[] ToArray()
		{
			Portal[] array = new Portal[_data.Count];
		...
		private void AddRange(Portal[] array, int range)
		{
			if (range == 0) return;

			if (_data.IsUnique)
			{
				foreach (Portal value in array)
				{
					CheckUnique(value);
				}
			}
		...
		private void CheckUnique(Portal value)
		{
			if (IndexOf(value) >= 0)
			{
		...
		private void CheckUnique(Portal value, int index)
		{
		...
		private sealed class Data
		{
			...
			public void SetCapacity(int capacity)
			{
				...
				if (capacity == 0)
				{
					Items = new Portal[DefaultCapacity];
					return;
				}

				Portal[] items = new Portal[capacity];
		...
		private sealed class ReadOnlyWrapper : PortalArrayList
		{
			...
			public override Portal this[int index]
			{
			...
			public override int Add(Portal value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(PortalArrayList collection)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(Portal[] array)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
			...
			{
				PortalArrayList wrapper =
					(PortalArrayList) base.Clone();

				return new ReadOnlyWrapper(wrapper._data);
			}

			public override void Insert(int index, Portal value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
