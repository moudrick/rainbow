...
namespace Rainbow.Core
{
	...
	public interface IRoleCollection
	{
		...
		/// <summary>
		/// Copies the entire <see cref="IRoleCollection"/> 
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Role"/> elements, 
		/// starting at the specified index of the target array.
		/// </summary>
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination 
		/// of the <see cref="Role"/> elements copied 
		/// from the <see cref="IRoleCollection"/>.
		...
		/// <see cref="IRoleCollection"/> is greater
		...
		/// </summary>
		/// <returns>
		/// An <see cref="IRoleEnumerator"/> for the entire 
		/// <see cref="IRoleCollection"/>.</returns>
		/// <remarks>
		/// Please refer to 
		...
		IRoleList : IRoleCollection
	{
		...
		/// <see cref="IRoleList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IRoleList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the 
		/// <see cref="IRoleList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IRoleList"/> 
		...
		/// </summary>
		/// <param name="index">
		/// The zero-based index of the <see cref="Role"/> 
		/// element to get or set.</param>
		/// <value>
		/// The <see cref="Role"/> element 
		...
		/// <see cref="IRoleList"/> is read-only.</exception>
		/// <remarks>
		...
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to be added 
		/// to the end of the <see cref="IRoleList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="IRoleList"/> index at which 
		/// the <paramref name="value"/> has been added.</returns>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IRoleList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The <b>IRoleList</b> has a fixed size.
		/// </para></exception>
		/// <remarks>
		...
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to locate 
		/// in the <see cref="IRoleList"/>.
		/// </param>
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="IRoleList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		...
		/// of the specified <see cref="Role"/> 
		/// in the <see cref="IRoleList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to locate 
		...
		/// <paramref name="value"/> in the <see cref="IRoleList"/>, 
		...
		/// <param name="value">
		/// The <see cref="Role"/> object to insert 
		/// into the <see cref="IRoleList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		...
		/// <see cref="Role"/> from the 
		/// <see cref="IRoleList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to remove 
	...
	public interface IRoleEnumerator
	{
		...
		/// <summary>
		/// Gets the current <see cref="Role"/> 
		/// element in the collection.
		/// </summary>
		/// <value>
		/// The current <see cref="Role"/> 
	...
	/// <see cref="Role"/> elements.
	/// </para><para>
	/// The <see cref="Role.RoleID"/> property
	/// of the <see cref="Role"/> class can be used as a key
	/// to locate elements in the <b>RoleArrayList</b>.
	/// </para><para>
	...
	/// current value of the <see cref="RoleArrayList.Count"/> property.
	/// </para></remarks>
	[Serializable]
	public class RoleArrayList : Component,
		IRoleList, IList, ICloneable
	{
		...
		/// </remarks>
		private RoleArrayList(Data data)
		{
			///
		...
		public RoleArrayList()
		{
			...
			//
			_data = new Data();
			_data.Items = new Role[Data.DefaultCapacity];
		}

		public RoleArrayList(IContainer container)
		{
			///
			/// Required for Windows.Forms Class Composition Designer support
			///
		...
		/// <see cref="RoleArrayList"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="capacity"/> is less than zero.</exception>
		/// <remarks>
		/// Please refer to <see cref="ArrayList(Int32)"/> for details.
		/// </remarks>
		public RoleArrayList(int capacity)
		{
			///
			/// Required for Windows.Forms Class Composition Designer support
			///
			...
			_data = new Data();
			_data.Items = new Role[capacity];
		}

		#endregion

		#region RoleArrayList(RoleArrayList)

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="RoleArrayList"/> class that
		...
		/// </remarks>
		public RoleArrayList(RoleArrayList collection)
		{
			///
			/// Required for Windows.Forms Class Composition Designer support
			///
		...
		/// Please refer to <see cref="ArrayList(ICollection)"/> for details.
		/// </remarks>
		public RoleArrayList(Role[] array)
		{
			///
			/// Required for Windows.Forms Class Composition Designer support
			///
			...
			_data = new Data();
			_data.Items = new Role[array.Length];
		...
		/// <summary>
		/// Gets or sets the capacity of the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <value>
		/// The number of elements that the
		/// <see cref="RoleArrayList"/> can contain.
		/// </value>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <b>Capacity</b> is set to a value that is
		/// less than <see cref="Count"/>.</exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the <see cref="RoleArrayList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="RoleArrayList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="RoleArrayList"/>
		/// has a fixed size; otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="RoleArrayList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="RoleArrayList"/>
		/// is read-only; otherwise, <c>false</c>.
		...
		/// <summary>
		/// Gets a value indicating whether access to the
		/// <see cref="RoleArrayList"/> is synchronized (thread-safe).
		/// </summary>
		/// <value>
		/// <c>true</c> if access to the <see cref="RoleArrayList"/>
		/// is synchronized (thread-safe); otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <see cref="RoleArrayList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The property is set, the <b>RoleArrayList</b>
		/// already contains the specified element at a different index,
		/// and the <b>RoleArrayList</b> ensures
		...
		/// <summary>
		///     Convert to string using Role Name
		/// </summary>
		/// 
		/// <returns>
		///     A string value...
		...
		/// <summary>
		/// Adds a <see cref="Role"/> to the end
		/// of the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to be added
		/// to the end of the <see cref="RoleArrayList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="RoleArrayList"/>
		...
		/// </para><para>-or-</para><para>
		/// The <b>RoleArrayList</b>
		/// already contains <paramref name="value"/>,
		/// and the <b>RoleArrayList</b>
		...
		/// <see cref="RoleArrayList"/>. This argument
		/// must be compatible with <see cref="Role"/>.
		/// </param>
		/// <returns>
		/// The <see cref="RoleArrayList"/>
		/// index at which the <paramref name="value"/> has been added.
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="RoleArrayList"/> whose elements
		...
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>RoleArrayList</b> already contains one
		...
		/// </remarks>
		public virtual void AddRange(RoleArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>RoleArrayList</b> already contains
		...
		#region BinarySearch(Role)

		/// <summary>
		/// Searches the entire sorted <see cref="RoleArrayList"/>
		/// for an <see cref="Role"/> element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to locate
		/// in the <see cref="RoleArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of <paramref name="value"/> in the sorted
		/// <see cref="RoleArrayList"/>, if <paramref name="value"/>
		...
		/// </remarks>
		public int BinarySearch(Role value)
		{
			if (_data.Count == 0) return ~0;

			int index, left = 0, right = _data.Count - 1;
			Role[] items = _data.Items;

			do
			{
				index = (left + right)/2;
				Role current = items[index];
		...
		#region BinarySearch(Role, IComparer)

		/// <overloads>
		/// Uses a binary search algorithm to locate a specific element
		/// in the sorted <see cref="RoleArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Searches the entire sorted <see cref="RoleArrayList"/>
		...
		#region BinarySearch(Int32, Int32, Role, IComparer)

		/// <summary>
		/// Searches a section of the sorted
		/// <see cref="RoleArrayList"/> for an
		/// <see cref="Role"/> element using the
		/// specified comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="index">
		...
		/// <summary>
		/// Removes all elements from the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="RoleArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <summary>
		/// Creates a shallow copy of the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <returns>
		/// A shallow copy of the <see cref="RoleArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="RoleArrayList"/>
		/// contains the specified <see cref="Role"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object to locate
		...
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="RoleArrayList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="RoleArrayList"/> contains
		/// the specified <see cref="Role.RoleID"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Role.RoleID"/> value to locate
		/// in the <see cref="RoleArrayList"/>.
		...
		/// of the <see cref="Role.RoleID"/> property
		/// of each <see cref="Role"/> element, rather than
		...
		/// <summary>
		/// Creates a deep copy of the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <returns>
		/// A deep copy of the <see cref="RoleArrayList"/>.
		/// </returns>
		/// <remarks><para>
		/// <b>Copy</b> has the same effect as <see cref="Clone"/>
		/// because <see cref="Role"/> is a value type.
		/// </para><para>
		/// <b>Copy</b> always returns a <b>RoleArrayList</b> 
		...
		/// </para></remarks>
		public RoleArrayList Copy()
		{
			int count = _data.Count;
			RoleArrayList copy =
				new RoleArrayList(count);
		...
		/// <overloads>
		/// Copies the <see cref="RoleArrayList"/>
		/// or a portion of it to a one-dimensional array.
		/// </overloads>
		/// <summary>
		/// Copies the entire <see cref="RoleArrayList"/>
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Role"/> elements,
		...
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination
		/// of the <see cref="Role"/> elements copied from the
		/// <see cref="RoleArrayList"/>.
		/// The <b>Array</b> must have zero-based indexing.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		...
		/// </para><para>-or-</para><para>
		/// The number of elements in the source
		/// <see cref="RoleArrayList"/> is greater
		/// than the available space from <paramref name="arrayIndex"/>
		/// to the end of the destination <paramref name="array"/>.
		/// </para></exception>
		/// <remarks>
		...
		/// <summary>
		/// Gets the <see cref="Role"/> element
		/// associated with the first occurrence of the specified
		/// <see cref="Role.RoleID"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Role.RoleID"/>
		/// value whose element to get.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The <see cref="Role"/> element associated
		/// with the first occurrence of the specified
		/// <paramref name="key"/>, if found; otherwise,
		/// a default-initialized <b>Role</b> object.
		/// </returns>
		/// <remarks>
		/// <b>GetByKey</b> compares the specified <paramref name="key"/>
		/// to the value of the <see cref="Role.RoleID"/>
		/// property of each <see cref="Role"/> element,
		...
		/// <summary>
		/// Returns an <see cref="IRoleEnumerator"/> that can
		/// iterate through the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IRoleEnumerator"/> for the entire
		/// <see cref="RoleArrayList"/>.
		...
		/// </remarks>
		public IRoleEnumerator GetEnumerator()
		{
		...
		/// <summary>
		/// Returns the zero-based index of the first occurrence
		/// of the specified <see cref="Role"/> in the
		/// <see cref="RoleArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Role"/> object
		/// to locate in the <see cref="RoleArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="RoleArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		/// </summary>
		/// <param name="value">
		/// The object to locate in the <see cref="RoleArrayList"/>.
		...
		/// specified <see cref="Role.RoleID"/> value
		/// in the <see cref="RoleArrayList"/>.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Role.RoleID"/> value
		/// to locate in the <see cref="RoleArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="key"/> in the <see cref="RoleArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		public int IndexOfKey(int key)
		{
			...
			for (int i = 0; i < count; i++)
			{
				if ((object) key == null)
				{
					if ((object) items[i].RoleID == null)
						return i;
					continue;
				}

				if (key.Equals(items[i].RoleID))
					return i;
			}
		...
		/// <summary>
		/// Inserts a <see cref="Role"/> element into the
		/// <see cref="RoleArrayList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		...
		/// <param name="value">
		/// The <see cref="Role"/> object to insert
		/// into the <see cref="RoleArrayList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para><para>
		...
		/// should be inserted.</param>
		/// <param name="value">
		/// The object to insert into the <see cref="RoleArrayList"/>.
		/// This argument must be compatible with <see cref="Role"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="RoleArrayList"/> to wrap.</param>
		/// <returns>
		...
		/// </remarks>
		public static RoleArrayList ReadOnly(
			RoleArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		/// <param name="value">
		/// The <see cref="Role"/> object to remove
		/// from the <see cref="RoleArrayList"/>.
		/// </param>
		/// <exception cref="NotSupportedException">
		/// The <see cref="RoleArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <paramref name="index"/> and <paramref name="count"/>
		/// do not denote a valid range of elements in the
		/// <see cref="RoleArrayList"/>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		/// <para><paramref name="count"/> is less than zero.</para>
		...
		/// <see cref="RoleArrayList"/> or a portion of it.
		/// </overloads>
		/// <summary>
		...
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="RoleArrayList"/> is read-only.
		/// </exception>
		/// <remarks>
		...
		/// <overloads>
		/// Sorts the elements in the <see cref="RoleArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Sorts the elements in the entire <see cref="RoleArrayList"/>
		...
		/// </exception>
		/// <exception cref="InvalidOperationException">
		/// One or more elements in the <see cref="RoleArrayList"/>
		...
		/// <see cref="RoleArrayList"/> using the specified comparer.
		/// </summary>
		/// <param name="comparer">
		/// <para>The <see cref="IComparer"/> implementation
		/// to use when comparing elements.</para>
		...
		/// <summary>
		/// Copies the elements of the <see cref="RoleArrayList"/>
		/// to a new <see cref="Array"/> of
		/// <see cref="Role"/> elements.
		/// </summary>
		/// <returns>
		/// A one-dimensional <see cref="Array"/> of
		/// <see cref="Role"/> elements containing copies of the
		/// elements of the <see cref="RoleArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		public Role[] ToArray()
		{
			Role[] array = new Role[_data.Count];
		...
		private void AddRange(Role[] array, int range)
		{
			if (range == 0) return;
		...
		private void CheckUnique(Role value, int index)
		{
		...
		private sealed class Data
		{
			...
			public void SetCapacity(int capacity)
			{
				...
				if (capacity == 0)
				{
					Items = new Role[DefaultCapacity];
					return;
				}

				Role[] items = new Role[capacity];
		...
		private sealed class ReadOnlyWrapper : RoleArrayList
		{
			...
			public override void AddRange(RoleArrayList collection)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
			...
			{
				RoleArrayList wrapper =
					(RoleArrayList) base.Clone();
