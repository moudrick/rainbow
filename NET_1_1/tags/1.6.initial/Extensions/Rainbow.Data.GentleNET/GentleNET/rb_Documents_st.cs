...
{
	#region rb_Documents_st
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Documents_st")]
	public class rb_Documents_st : Persistent
	{
		#region Members
		...
		[TableColumn("FileNameUrl")]
		protected string fileNameUrl;
		[TableColumn("FileFriendlyName")]
		protected string fileFriendlyName;
		[TableColumn("Category")]
		protected string category;
		[TableColumn("Content")]
		protected byte[] content;
		[TableColumn("ContentType")]
		protected string contentType;
		[TableColumn("ContentSize")]
		...
		{
			get{ return fileNameUrl != null ?fileNameUrl.TrimEnd() : null; }
			set{ _changed |= fileNameUrl != value; fileNameUrl = value; invalidatedListAll =  _changed;}
		}
		
		public string FileFriendlyName
		{
			get{ return fileFriendlyName != null ?fileFriendlyName.TrimEnd() : null; }
			set{ _changed |= fileFriendlyName != value; fileFriendlyName = value; invalidatedListAll =  _changed;}
		}
		
		public string Category
		{
			get{ return category != null ?category.TrimEnd() : null; }
			set{ _changed |= category != value; category = value; invalidatedListAll =  _changed;}
		}
		
		public byte[] Content
		{
			get{ return content; }
			set{ _changed |= content != value; content = value; invalidatedListAll =  _changed;}
		}
		
		public string ContentType
		{
			get{ return contentType != null ?contentType.TrimEnd() : null; }
			set{ _changed |= contentType != value; contentType = value; invalidatedListAll =  _changed;}
		}
		
		public int ContentSize
		{
			get{ return contentSize; }
			set{ _changed |= contentSize != value; contentSize = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Documents_st) ) as ArrayList;
		...
		public static rb_Documents_st Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Documents_st), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Documents_st), key ) as rb_Documents_st;
		}
		...
		/// table "rb_Modules", using relation table "rb_Documents_st"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Documents_st));
		}
		#endregion
