...
namespace Rainbow.Data.GentleNET
{
	...
	/// </summary>
	[Serializable]
	[TableName("rb_Links_st")]
	public class rb_Links_st : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Links_st) ) as ArrayList;
		...
		public static rb_Links_st Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Links_st), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Links_st), key ) as rb_Links_st;
		}
		...
		/// table "rb_Modules", using relation table "rb_Links_st"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Links_st));
		}
		#endregion
