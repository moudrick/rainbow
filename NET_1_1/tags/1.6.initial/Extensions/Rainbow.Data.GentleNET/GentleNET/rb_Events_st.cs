...
namespace Rainbow.Data.GentleNET
{
	...
	/// </summary>
	[Serializable]
	[TableName("rb_Events_st")]
	public class rb_Events_st : Persistent
	{
		#region Members
		...
		[TableColumn("WhereWhen")]
		protected string whereWhen;
		[TableColumn("Description")]
		protected string description;
		[TableColumn("ExpireDate")]
		protected DateTime expireDate;
		[TableColumn("AllDay", NotNull=true)]
		...
		{
			get{ return whereWhen != null ?whereWhen.TrimEnd() : null; }
			set{ _changed |= whereWhen != value; whereWhen = value; invalidatedListAll =  _changed;}
		}
		...
		{
			get{ return allDay; }
			set{ _changed |= allDay != value; allDay = value; invalidatedListAll =  _changed;}
		}
		...
		{
			get{ return startTime != null ?startTime.TrimEnd() : null; }
			set{ _changed |= startTime != value; startTime = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Events_st) ) as ArrayList;
		...
		public static rb_Events_st Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Events_st), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Events_st), key ) as rb_Events_st;
		}
		...
		/// table "rb_Modules", using relation table "rb_Events_st"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Events_st));
		}
		#endregion
