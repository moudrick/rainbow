...
{
	#region rb_SolutionModuleDefinitions
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_SolutionModuleDefinitions")]
	public class rb_SolutionModuleDefinitions : Persistent
	{
		#region Members
		private bool _changed = false;
		private static bool invalidatedListAll = true;
		private static ArrayList listAllCache = null;
		[TableColumn("SolutionModDefID", NotNull=true), PrimaryKey(AutoGenerated=true)]
		protected int solutionModDefID;
		...
		[TableColumn("SolutionsID", NotNull=true), ForeignKey("rb_Solutions", "SolutionsID")]
		protected int solutionsID;
		#endregion
		...
		/// </summary> 
		public rb_SolutionModuleDefinitions( 
		...
		/// </summary> 
		public rb_SolutionModuleDefinitions( 
				int SolutionModDefID, 
				Guid GeneralModDefID, 
				int SolutionsID)
		{
			solutionModDefID = SolutionModDefID;
			generalModDefID = GeneralModDefID;
			solutionsID = SolutionsID;
		}
		...
		{
			get{ return solutionsID; }
			set{ _changed |= solutionsID != value; solutionsID = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_SolutionModuleDefinitions) ) as ArrayList;
		...
		public static rb_SolutionModuleDefinitions Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_SolutionModuleDefinitions), true, "SolutionModDefID", id );
			return Broker.RetrieveInstance( typeof(rb_SolutionModuleDefinitions), key ) as rb_SolutionModuleDefinitions;
		}
		...
		// Key: FK_rb_SolutionModuleDefintions_rb_Solutions primary table: rb_Solutions primary column: SolutionsID foreign column: SolutionsID foreign table: rb_SolutionModuleDefinitions
		...
		/// table "rb_GeneralModuleDefinitions", using relation table "rb_SolutionModuleDefinitions"
		/// </summary>
		public IList referencedrb_GeneralModuleDefinitions()
		{
			return new GentleList( typeof(rb_GeneralModuleDefinitions), this, typeof(rb_SolutionModuleDefinitions));
		}
		...
		/// </summary>
		public IList referencedrb_Solutions()
		{
