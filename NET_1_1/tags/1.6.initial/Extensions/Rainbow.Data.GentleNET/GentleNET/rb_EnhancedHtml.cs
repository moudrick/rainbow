...
{
	#region rb_EnhancedHtml
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_EnhancedHtml")]
	public class rb_EnhancedHtml : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_EnhancedHtml) ) as ArrayList;
		...
		public static rb_EnhancedHtml Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_EnhancedHtml), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_EnhancedHtml), key ) as rb_EnhancedHtml;
		}
		...
		/// table "rb_Modules", using relation table "rb_EnhancedHtml"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_EnhancedHtml));
		}
		#endregion
