...
{
	#region rb_Pictures_st
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Pictures_st")]
	public class rb_Pictures_st : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Pictures_st) ) as ArrayList;
		...
		public static rb_Pictures_st Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Pictures_st), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Pictures_st), key ) as rb_Pictures_st;
		}
