...
namespace Rainbow.Framework.Design
{
    ...
    public partial class Layout : ILayout
    {
        /// <summary>
        /// Gets or sets the id.
        /// </summary>
        ...
        {
            get { return System.IO.Path.GetFullPath(HttpContext.Current.Server.MapPath(WebPath.ToString())); }
        }
        ...
        #region IComparable<ILayout> Members
