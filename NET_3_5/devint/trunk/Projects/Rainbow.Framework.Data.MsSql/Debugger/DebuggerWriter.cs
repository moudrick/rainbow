...
namespace Rainbow.Framework.Data.MsSql.Debugger
{
    /// <summary>
    /// Implements a <see cref="TextWriter"/> for writing information to the debugger log.
    /// </summary>
    /// <seealso cref="System.Diagnostics.Debugger.Log"/>
    /// <example>
    /// MyDataContext db = new MyDataContext();
    /// db.Log = new DebuggerWriter();
    /// </example>
    /// <remarks>
    /// Courtesy Kris Vandermotten at http://www.u2u.info/Blogs/Kris/Lists/Posts/Post.aspx?ID=11
    /// </remarks>
    public class DebuggerWriter : TextWriter
    {
        ...
        public DebuggerWriter()
            : this(0, System.Diagnostics.Debugger.DefaultCategory)
        {
        }
        ...
        public override void Write(char value)
        {
            ...
            System.Diagnostics.Debugger.Log(level, category, value.ToString());
        }
        ...
        public override void Write(string value)
        {
            ...
            if (value != null)
            {
                System.Diagnostics.Debugger.Log(level, category, value);
            }
        }
        ...
        public override void Write(char[] buffer, int index, int count)
        {
            ...
            System.Diagnostics.Debugger.Log(level, category, new string(buffer, index, count));
        }
