...
namespace Rainbow.DesktopModules
{
    ...
    public class Announcements : PortalModuleControl 
    {
		...
		private void BindData(int PageNumber)
		{
			...
			DataSet announces = announcements.GetAnnouncements(ModuleID, Version,pgModules.RecordsPerPage,pgModules.PageNumber);
		...
		{
			SearchDefinition s = new SearchDefinition("rb_Announcements", "Title", "Description", "CreatedByUser", "CreatedDate", searchField);
