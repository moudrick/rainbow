...
namespace Rainbow.DesktopModules 
{
	...
	public class Documents : PortalModuleControl 
	{
		...
		public Documents() 
		{
			...
			SettingItem	SortByField	= new SettingItem(new ListDataType(Localize.GetString("DOCUMENTS_SORTBY_FIELD_LIST", "File Name;Created Date")));
		...
		private void Page_Load(object sender, EventArgs e) 
		{
			...
			if (!Page.IsPostBack) 
			{
				...
				{
					if (Localize.GetString("DOCUMENTS_SORTBY_FIELD_LIST", "File Name;Created Date").IndexOf(sortFieldOption) > 0)
