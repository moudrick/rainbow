					...
					if ( Request.Form[prefix + dr["FieldTitle"]] != null)
					{
						switch (dr["FieldType"].ToString())
						{
							case "Int32":
								...
								{
									strMessage += "<br>" + dr["FieldTitle"].ToString() + " "+ Localize.GetString("UDT_VALIDINTEGER", "must contain a valid integer value");
									ValidInput = false;
								}
								break;
							case "Decimal":
								...
								{
									strMessage += "<br>" + dr["FieldTitle"].ToString() + " "+ Localize.GetString("UDT_VALIDDECIMAL", "must contain a valid decimal value");
									ValidInput = false;
								}
								break;
							case "DateTime":
								...
								{
									strMessage += "<br>" + dr["FieldTitle"].ToString() + " "+ Localize.GetString("UDT_VALIDDATE", "must contain a valid date value");
									ValidInput = false;
								}
								break;
							case "Boolean":
								...
								{
									strMessage += "<br>" + dr["FieldTitle"].ToString() + " "+ Localize.GetString("UDT_VALIDBOOLEAN", "must contain a valid true/false value");
									ValidInput = false;
								}
								break;
						}
