...
{
	#region rb_HtmlText_st
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_HtmlText_st")]
	public class rb_HtmlText_st : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_HtmlText_st) ) as ArrayList;
		...
		public static rb_HtmlText_st Retrieve(int id )
		{
		  
			Key key = new Key( typeof(rb_HtmlText_st), true, "ModuleID", id );
			return Broker.RetrieveInstance( typeof(rb_HtmlText_st), key ) as rb_HtmlText_st;
		}
		...
		/// table "rb_Modules", using relation table "rb_HtmlText_st"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_HtmlText_st));
		}
		#endregion
