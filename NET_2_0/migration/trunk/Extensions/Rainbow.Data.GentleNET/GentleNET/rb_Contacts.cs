...
namespace Rainbow.Data.GentleNET
{
	...
	/// </summary>
	[Serializable]
	[TableName("rb_Contacts")]
	public class rb_Contacts : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Contacts) ) as ArrayList;
		...
		public static rb_Contacts Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Contacts), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Contacts), key ) as rb_Contacts;
		}
		...
		/// table "rb_Modules", using relation table "rb_Contacts"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Contacts));
		}
		#endregion
