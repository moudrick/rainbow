...
namespace Rainbow.Data.GentleNET
{
	...
	/// </summary>
	[Serializable]
	[TableName("rb_Solutions")]
	public class rb_Solutions : Persistent
	{
		#region Members
		private bool _changed = false;
		private static bool invalidatedListAll = true;
		private static ArrayList listAllCache = null;
		[TableColumn("SolutionsID", NotNull=true), PrimaryKey(AutoGenerated=true)]
		protected int solutionsID;
		[TableColumn("SolDescription", NotNull=true)]
		protected string solDescription;
		#endregion
		...
		{
			get{ return solDescription != null ?solDescription.TrimEnd() : null; }
			set{ _changed |= solDescription != value; solDescription = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Solutions) ) as ArrayList;
		...
		public static rb_Solutions Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Solutions), true, "SolutionsID", id );
			return Broker.RetrieveInstance( typeof(rb_Solutions), key ) as rb_Solutions;
		}
