...
{
	#region rb_Discussion
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Discussion")]
	public class rb_Discussion : Persistent
	{
		#region Members
		...
		public string Body
		{
			get{ return body != null ?body.TrimEnd() : null; }
			set{ _changed |= body != value; body = value; invalidatedListAll =  _changed;}
		}
		
		public string DisplayOrder
		{
			get{ return displayOrder != null ?displayOrder.TrimEnd() : null; }
		...
		public int ViewCount
		{
			...
			set{ _changed |= viewCount != value; viewCount = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Discussion) ) as ArrayList;
		...
		public static rb_Discussion Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Discussion), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Discussion), key ) as rb_Discussion;
		}
		...
		/// table "rb_Modules", using relation table "rb_Discussion"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Discussion));
		}
		#endregion
