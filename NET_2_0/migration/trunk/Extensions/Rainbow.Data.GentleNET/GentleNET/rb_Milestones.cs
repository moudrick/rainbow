...
{
	#region rb_Milestones
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Milestones")]
	public class rb_Milestones : Persistent
	{
		#region Members
		...
		[TableColumn("ModuleID"), ForeignKey("rb_Modules", "ModuleID")]
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Milestones) ) as ArrayList;
		...
		public static rb_Milestones Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Milestones), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Milestones), key ) as rb_Milestones;
		}
		...
		/// table "rb_Modules", using relation table "rb_Milestones"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Milestones));
		}
		#endregion
