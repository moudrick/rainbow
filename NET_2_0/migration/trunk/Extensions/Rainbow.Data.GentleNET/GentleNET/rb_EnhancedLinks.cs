...
{
	#region rb_EnhancedLinks
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_EnhancedLinks")]
	public class rb_EnhancedLinks : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_EnhancedLinks) ) as ArrayList;
		...
		public static rb_EnhancedLinks Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_EnhancedLinks), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_EnhancedLinks), key ) as rb_EnhancedLinks;
		}
		...
		/// table "rb_Modules", using relation table "rb_EnhancedLinks"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_EnhancedLinks));
		}
		#endregion
