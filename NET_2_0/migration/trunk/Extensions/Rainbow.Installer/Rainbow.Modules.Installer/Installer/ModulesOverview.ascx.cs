...
namespace Rainbow.DesktopModules.Installer
{
    ...
    /// </summary>
    public class ModuleOverview : PortalModuleControl 
    {
		...
		private void defsList_ItemCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
		{
			...
			// Go to edit page
			Response.Redirect(HttpUrlBuilder.BuildUrl("~/DesktopModules/Installer/EditPortalModule.aspx", TabID, "DefID=" + GeneralModDefID + "&Mid=" + ModuleID));
		}
