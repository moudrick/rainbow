...
{
	#region rb_Announcements_st
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_Announcements_st")]
	public class rb_Announcements_st : Persistent
	{
		#region Members
		...
		[TableColumn("MobileMoreLink")]
		protected string mobileMoreLink;
		...
		{
			get{ return mobileMoreLink != null ?mobileMoreLink.TrimEnd() : null; }
			set{ _changed |= mobileMoreLink != value; mobileMoreLink = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Announcements_st) ) as ArrayList;
		...
		public static rb_Announcements_st Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Announcements_st), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Announcements_st), key ) as rb_Announcements_st;
		}
		...
		/// table "rb_Modules", using relation table "rb_Announcements_st"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Announcements_st));
		}
		#endregion
