...
namespace Rainbow.Data.GentleNET
{
	...
	/// </summary>
	[Serializable]
	[TableName("rb_Documents")]
	public class rb_Documents : Persistent
	{
		#region Members
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_Documents) ) as ArrayList;
		...
		public static rb_Documents Retrieve(int id )
		{
			...
			Key key = new Key( typeof(rb_Documents), true, "ItemID", id );
			return Broker.RetrieveInstance( typeof(rb_Documents), key ) as rb_Documents;
		}
		...
		/// table "rb_Modules", using relation table "rb_Documents"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_Documents));
		}
		#endregion
