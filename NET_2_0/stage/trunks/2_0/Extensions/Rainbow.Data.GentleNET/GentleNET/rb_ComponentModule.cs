...
{
	#region rb_ComponentModule
	/// <summary>
	/// This object represents the properties and methods of a Employee.
	/// </summary>
	[Serializable]
	[TableName("rb_ComponentModule")]
	public class rb_ComponentModule : Persistent
	{
		#region Members
		...
		{
			get{ return component != null ?component.TrimEnd() : null; }
			set{ _changed |= component != value; component = value; invalidatedListAll =  _changed;}
		}
		...
		static public IList ListAll
		{
			...
			{ 
				...
				{
					listAllCache = Broker.RetrieveList( typeof(rb_ComponentModule) ) as ArrayList;
		...
		public static rb_ComponentModule Retrieve(int id )
		{
		  
			Key key = new Key( typeof(rb_ComponentModule), true, "ModuleID", id );
			return Broker.RetrieveInstance( typeof(rb_ComponentModule), key ) as rb_ComponentModule;
		}
		...
		/// table "rb_Modules", using relation table "rb_ComponentModule"
		/// </summary>
		public IList referencedrb_Modules()
		{
			return new GentleList( typeof(rb_Modules), this, typeof(rb_ComponentModule));
		}
		#endregion
