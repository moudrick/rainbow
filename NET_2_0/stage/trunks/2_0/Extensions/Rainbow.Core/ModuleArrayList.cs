...
namespace Rainbow.Core
{
	...
	#region Interface IModuleCollection

	/// <summary>
	/// Defines size, enumerators, and synchronization methods for strongly
	/// typed collections of <see cref="Module"/> elements.
	/// </summary>
	/// <remarks>
	/// <b>IModuleCollection</b> 
	/// provides an <see cref="ICollection"/> that is strongly typed for 
	/// <see cref="Module"/> elements.
	/// </remarks>
	public interface IModuleCollection
	{
		...
		/// <summary>
		/// Copies the entire <see cref="IModuleCollection"/> 
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Module"/> elements, 
		/// starting at the specified index of the target array.
		/// </summary>
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination 
		/// of the <see cref="Module"/> elements copied 
		/// from the <see cref="IModuleCollection"/>.
		...
		/// <see cref="IModuleCollection"/> is greater
		...
		/// </remarks>
		void CopyTo(Module[] array, int arrayIndex);
		...
		/// <summary>
		/// Returns an <see cref="IModuleEnumerator"/> that can
		/// iterate through the <see cref="IModuleCollection"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IModuleEnumerator"/> for the entire 
		/// <see cref="IModuleCollection"/>.</returns>
		/// <remarks>
		/// Please refer to 
		/// <see cref="IEnumerable.GetEnumerator"/> for details.
		/// </remarks>
		IModuleEnumerator GetEnumerator();
	...
	#region Interface IModuleList

	/// <summary>
	/// Represents a strongly typed collection 
	/// of <see cref="Module"/> objects 
		...
		IModuleList : IModuleCollection
	{
		...
		/// <see cref="IModuleList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IModuleList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the 
		/// <see cref="IModuleList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="IModuleList"/> 
		...
		/// </summary>
		/// <param name="index">
		/// The zero-based index of the <see cref="Module"/> 
		/// element to get or set.</param>
		/// <value>
		/// The <see cref="Module"/> element 
		...
		/// <see cref="IModuleCollection.Count"/>.</para>
		/// </exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the 
		/// <see cref="IModuleList"/> is read-only.</exception>
		/// <remarks>
		/// Please refer to <see cref="IList.this"/> for details.
		/// </remarks>
		Module this[int index] { get; set; }
		...
		/// <summary>
		/// Adds a <see cref="Module"/> to the end 
		/// of the <see cref="IModuleList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to be added 
		/// to the end of the <see cref="IModuleList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="IModuleList"/> index at which 
		/// the <paramref name="value"/> has been added.</returns>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IModuleList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The <b>IModuleList</b> has a fixed size.
		/// </para></exception>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="IModuleList"/>
		/// contains the specified <see cref="Module"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to locate 
		/// in the <see cref="IModuleList"/>.
		/// </param>
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="IModuleList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		/// Please refer to <see cref="IList.Contains"/> for details.
		/// </remarks>
		bool Contains(Module value);
		...
		/// of the specified <see cref="Module"/> 
		/// in the <see cref="IModuleList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to locate 
		...
		/// <paramref name="value"/> in the <see cref="IModuleList"/>, 
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		/// Please refer to <see cref="IList.IndexOf"/> for details.
		/// </remarks>
		int IndexOf(Module value);
		...
		/// <summary>
		/// Inserts a <see cref="Module"/> element into the
		/// <see cref="IModuleList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		/// The zero-based index at which 
		/// <paramref name="value"/> should be inserted.</param>
		/// <param name="value">
		/// The <see cref="Module"/> object to insert 
		/// into the <see cref="IModuleList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		...
		/// </remarks>
		void Insert(int index, Module value);
		...
		/// <see cref="Module"/> from the 
		/// <see cref="IModuleList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to remove 
		/// from the <see cref="IModuleList"/>.
		/// </param>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="IModuleList"/> is read-only.
		/// </para><para>-or-</para><para>
	...
	#region Interface IModuleEnumerator
	...
	public interface IModuleEnumerator
	{
		...
		/// <summary>
		/// Gets the current <see cref="Module"/> 
		/// element in the collection.
		/// </summary>
		/// <value>
		/// The current <see cref="Module"/> 
	...
	/// <see cref="Module"/> elements.
	/// </para><para>
	/// The <see cref="Module.Id"/> property
	/// of the <see cref="Module"/> class can be used as a key
	/// to locate elements in the <b>ModuleArrayList</b>.
	/// </para><para>
	...
	/// current value of the <see cref="ModuleArrayList.Count"/> property.
	/// </para></remarks>
	[Serializable]
	public class ModuleArrayList : IModuleList, IList, ICloneable,
		IComparer, IDisposable
	{
		...
		/// <see cref="ModuleArrayList"/> class
		...
		/// </remarks>
		private ModuleArrayList(Data data)
		{
			_data = data;
		}
		...
		#region ModuleArrayList()

		public ModuleArrayList(IContainer container)
		{
			_data = new Data();
			_data.Items = new Module[Data.DefaultCapacity];
		}
		...
		/// <see cref="ModuleArrayList"/> can contain.</param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <paramref name="capacity"/> is less than zero.</exception>
		/// <remarks>
		/// Please refer to <see cref="ArrayList(Int32)"/> for details.
		/// </remarks>
		public ModuleArrayList(int capacity)
		{
			if (capacity < 0)
			{
			...
			_data = new Data();
			_data.Items = new Module[capacity];
		}

		#endregion

		#region ModuleArrayList(ModuleArrayList)

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="ModuleArrayList"/> class that
		...
		/// </remarks>
		public ModuleArrayList(ModuleArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");

			_data = new Data();
			_data.Items = new Module[collection.Count];
			AddRange(collection._data.Items, collection.Count);
		}

		#endregion

		#region ModuleArrayList(Module[])

		/// <summary>
		/// Initializes a new instance of the
		/// <see cref="ModuleArrayList"/> class
		/// that contains elements copied from the specified
		/// <see cref="Module"/> array and that has the
		/// same initial capacity as the number of elements copied.
		/// </summary>
		/// <param name="array">
		/// An <see cref="Array"/> of <see cref="Module"/>
		...
		/// Please refer to <see cref="ArrayList(ICollection)"/> for details.
		/// </remarks>
		public ModuleArrayList(Module[] array)
		{
			if (array == null)
				throw new ArgumentNullException("array");

			_data = new Data();
			_data.Items = new Module[array.Length];
		...
		/// <summary>
		/// Gets or sets the capacity of the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <value>
		/// The number of elements that the
		/// <see cref="ModuleArrayList"/> can contain.
		/// </value>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <b>Capacity</b> is set to a value that is
		/// less than <see cref="Count"/>.</exception>
		/// <exception cref="NotSupportedException">
		/// The property is set, and the <see cref="ModuleArrayList"/> 
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="ModuleArrayList"/> has a fixed size.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="ModuleArrayList"/>
		/// has a fixed size; otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <summary>
		/// Gets a value indicating whether the
		/// <see cref="ModuleArrayList"/> is read-only.
		/// </summary>
		/// <value>
		/// <c>true</c> if the <see cref="ModuleArrayList"/>
		/// is read-only; otherwise, <c>false</c>.
		...
		/// <summary>
		/// Gets a value indicating whether access to the
		/// <see cref="ModuleArrayList"/> is synchronized (thread-safe).
		/// </summary>
		/// <value>
		/// <c>true</c> if access to the <see cref="ModuleArrayList"/>
		/// is synchronized (thread-safe); otherwise, <c>false</c>.
		/// The default is <c>false</c>.</value>
		/// <remarks>
		...
		/// <see cref="ModuleArrayList"/> is read-only.
		/// </para><para>-or-</para><para>
		/// The property is set, the <b>ModuleArrayList</b>
		/// already contains the specified element at a different index,
		/// and the <b>ModuleArrayList</b> ensures
		...
		/// with <see cref="Module"/>.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The property is set, and the
		/// <see cref="ModuleArrayList"/> is read-only.
		/// </para><para>-or-</para><para>
		...
		/// <summary>
		/// Adds a <see cref="Module"/> to the end
		/// of the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to be added
		/// to the end of the <see cref="ModuleArrayList"/>.
		/// </param>
		/// <returns>
		/// The <see cref="ModuleArrayList"/>
		...
		/// <see cref="ModuleArrayList"/>. This argument
		/// must be compatible with <see cref="Module"/>.
		/// </param>
		/// <returns>
		/// The <see cref="ModuleArrayList"/>
		/// index at which the <paramref name="value"/> has been added.
		...
		#region AddRange(ModuleArrayList)
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="ModuleArrayList"/> whose elements
		...
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>ModuleArrayList</b> already contains one
		...
		/// </remarks>
		public virtual void AddRange(ModuleArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		#region AddRange(Module[])

		/// <summary>
		/// Adds the elements of a <see cref="Module"/> array
		/// to the end of the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <param name="array">
		/// An <see cref="Array"/> of <see cref="Module"/>
		/// elements that should be added to the end of the
		/// <see cref="ModuleArrayList"/>.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="ModuleArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		/// The <b>ModuleArrayList</b> already contains
		...
		/// Please refer to <see cref="ArrayList.AddRange"/> for details.
		/// </remarks>
		public virtual void AddRange(Module[] array)
		{
			if (array == null)
				throw new ArgumentNullException("array");
		...
		#region BinarySearch(Module)

		/// <summary>
		/// Searches the entire sorted <see cref="ModuleArrayList"/>
		/// for an <see cref="Module"/> element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to locate
		/// in the <see cref="ModuleArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of <paramref name="value"/> in the sorted
		/// <see cref="ModuleArrayList"/>, if <paramref name="value"/>
		...
		/// </remarks>
		public int BinarySearch(Module value)
		{
			if (_data.Count == 0) return ~0;

			int index, left = 0, right = _data.Count - 1;
			Module[] items = _data.Items;

			do
			{
				index = (left + right)/2;
				Module current = items[index];
		...
		#region BinarySearch(Module, IComparer)

		/// <overloads>
		/// Uses a binary search algorithm to locate a specific element
		/// in the sorted <see cref="ModuleArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Searches the entire sorted <see cref="ModuleArrayList"/>
		...
		public int BinarySearch(
			Module value, IComparer comparer)
		{
		...
		#region BinarySearch(Int32, Int32, Module, IComparer)

		/// <summary>
		/// Searches a section of the sorted
		/// <see cref="ModuleArrayList"/> for an
		/// <see cref="Module"/> element using the
		/// specified comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="index">
		...
		/// <summary>
		/// Removes all elements from the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="ModuleArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <summary>
		/// Creates a shallow copy of the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <returns>
		/// A shallow copy of the <see cref="ModuleArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		{
			ModuleArrayList clone =
				new ModuleArrayList(_data.Count);
		...
		#region Contains(Module)

		/// <summary>
		/// Determines whether the <see cref="ModuleArrayList"/>
		/// contains the specified <see cref="Module"/> element.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object to locate
		...
		/// <returns>
		/// <c>true</c> if <paramref name="value"/> is found in the
		/// <see cref="ModuleArrayList"/>; otherwise, <c>false</c>.
		/// </returns>
		/// <remarks>
		...
		/// <summary>
		/// Determines whether the <see cref="ModuleArrayList"/> contains
		/// the specified <see cref="Module.Id"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Module.Id"/> value to locate
		/// in the <see cref="ModuleArrayList"/>.
		...
		/// of the <see cref="Module.Id"/> property
		/// of each <see cref="Module"/> element, rather than
		...
		/// <summary>
		/// Creates a deep copy of the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <returns>
		/// A deep copy of the <see cref="ModuleArrayList"/>.
		/// </returns>
		/// <remarks><para>
		/// <b>Copy</b> has the same effect as <see cref="Clone"/>
		/// because <see cref="Module"/> is a value type.
		/// </para><para>
		/// <b>Copy</b> always returns a <b>ModuleArrayList</b> 
		...
		/// </para></remarks>
		public ModuleArrayList Copy()
		{
			int count = _data.Count;
			ModuleArrayList copy =
				new ModuleArrayList(count);

			Array.Copy(_data.Items, copy._data.Items, count);
		...
		#region CopyTo(Module[])

		/// <overloads>
		/// Copies the <see cref="ModuleArrayList"/>
		/// or a portion of it to a one-dimensional array.
		/// </overloads>
		/// <summary>
		/// Copies the entire <see cref="ModuleArrayList"/>
		/// to a one-dimensional <see cref="Array"/>
		/// of <see cref="Module"/> elements,
		...
		/// <param name="array">
		/// The one-dimensional <see cref="Array"/> that is the destination
		/// of the <see cref="Module"/> elements copied from the
		/// <see cref="ModuleArrayList"/>.
		/// The <b>Array</b> must have zero-based indexing.</param>
		/// <exception cref="ArgumentNullException">
		/// <paramref name="array"/> is a null reference.</exception>
		...
		/// </para><para>-or-</para><para>
		/// The number of elements in the source
		/// <see cref="ModuleArrayList"/> is greater
		/// than the available space from <paramref name="arrayIndex"/>
		/// to the end of the destination <paramref name="array"/>.
		/// </para></exception>
		/// <remarks>
		...
		/// <summary>
		/// Gets the <see cref="Module"/> element
		/// associated with the first occurrence of the specified
		/// <see cref="Module.Id"/> value.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Module.Id"/>
		/// value whose element to get.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The <see cref="Module"/> element associated
		/// with the first occurrence of the specified
		/// <paramref name="key"/>, if found; otherwise,
		/// a default-initialized <b>Module</b> object.
		/// </returns>
		/// <remarks>
		/// <b>GetByKey</b> compares the specified <paramref name="key"/>
		/// to the value of the <see cref="Module.Id"/>
		/// property of each <see cref="Module"/> element,
		/// and returns the first matching element.
		/// </remarks>
		public Module GetByKey(int key)
		{
		...
		#region GetEnumerator: IModuleEnumerator

		/// <summary>
		/// Returns an <see cref="IModuleEnumerator"/> that can
		/// iterate through the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IModuleEnumerator"/> for the entire
		/// <see cref="ModuleArrayList"/>.
		...
		/// </remarks>
		public IModuleEnumerator GetEnumerator()
		{
		...
		#region IndexOf(Module)

		/// <summary>
		/// Returns the zero-based index of the first occurrence
		/// of the specified <see cref="Module"/> in the
		/// <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <param name="value">
		/// The <see cref="Module"/> object
		/// to locate in the <see cref="ModuleArrayList"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="ModuleArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		/// </summary>
		/// <param name="value">
		/// The object to locate in the <see cref="ModuleArrayList"/>.
		/// This argument must be compatible with <see cref="Module"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="value"/> in the <see cref="ModuleArrayList"/>,
		...
		/// specified <see cref="Module.Id"/> value
		/// in the <see cref="ModuleArrayList"/>.
		/// </summary>
		/// <param name="key">
		/// The <see cref="Module.Id"/> value
		/// to locate in the <see cref="ModuleArrayList"/>.
		/// This argument may be a null reference.
		/// </param>
		/// <returns>
		/// The zero-based index of the first occurrence of
		/// <paramref name="key"/> in the <see cref="ModuleArrayList"/>,
		/// if found; otherwise, -1.</returns>
		/// <remarks>
		...
		public int IndexOfKey(int key)
		{
			...
			for (int i = 0; i < count; i++)
			{
				if ((object) key == null)
				{
					if ((object) items[i].Id == null)
						return i;
					continue;
				}

				if (key.Equals(items[i].Id))
					return i;
			}
		...
		#region Insert(Int32, Module)

		/// <summary>
		/// Inserts a <see cref="Module"/> element into the
		/// <see cref="ModuleArrayList"/> at the specified index.
		/// </summary>
		/// <param name="index">
		...
		/// <param name="value">
		/// The <see cref="Module"/> object to insert
		/// into the <see cref="ModuleArrayList"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para><para>
		...
		/// </remarks>
		public virtual void Insert(int index, Module value)
		{
			int count = _data.Count;
		...
		/// should be inserted.</param>
		/// <param name="value">
		/// The object to insert into the <see cref="ModuleArrayList"/>.
		/// This argument must be compatible with <see cref="Module"/>.
		/// </param>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		...
		/// is not compatible with <see cref="Module"/>.</exception>
		/// <exception cref="NotSupportedException"><para>
		/// The <see cref="ModuleArrayList"/> 
		/// is read-only or has a fixed size.
		/// </para><para>-or-</para><para>
		...
		/// </summary>
		/// <param name="collection">
		/// The <see cref="ModuleArrayList"/> to wrap.</param>
		/// <returns>
		...
		/// </remarks>
		public static ModuleArrayList ReadOnly(
			ModuleArrayList collection)
		{
			if (collection == null)
				throw new ArgumentNullException("collection");
		...
		/// <param name="value">
		/// The <see cref="Module"/> object to remove
		/// from the <see cref="ModuleArrayList"/>.
		/// </param>
		/// <exception cref="NotSupportedException">
		/// The <see cref="ModuleArrayList"/> 
		/// is read-only or has a fixed size.</exception>
		...
		/// <paramref name="index"/> and <paramref name="count"/>
		/// do not denote a valid range of elements in the
		/// <see cref="ModuleArrayList"/>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">
		/// <para><paramref name="index"/> is less than zero.</para>
		/// <para>-or-</para>
		/// <para><paramref name="count"/> is less than zero.</para>
		...
		/// <see cref="ModuleArrayList"/> or a portion of it.
		/// </overloads>
		/// <summary>
		...
		/// </summary>
		/// <exception cref="NotSupportedException">
		/// The <see cref="ModuleArrayList"/> is read-only.
		/// </exception>
		/// <remarks>
		...
		/// <overloads>
		/// Sorts the elements in the <see cref="ModuleArrayList"/>
		/// or a portion of it.
		/// </overloads>
		/// <summary>
		/// Sorts the elements in the entire <see cref="ModuleArrayList"/>
		...
		/// </exception>
		/// <exception cref="InvalidOperationException">
		/// One or more elements in the <see cref="ModuleArrayList"/>
		...
		/// <see cref="ModuleArrayList"/> using the specified comparer.
		/// </summary>
		/// <param name="comparer">
		/// <para>The <see cref="IComparer"/> implementation
		/// to use when comparing elements.</para>
		...
		/// <summary>
		/// Copies the elements of the <see cref="ModuleArrayList"/>
		/// to a new <see cref="Array"/> of
		/// <see cref="Module"/> elements.
		/// </summary>
		/// <returns>
		/// A one-dimensional <see cref="Array"/> of
		/// <see cref="Module"/> elements containing copies of the
		/// elements of the <see cref="ModuleArrayList"/>.
		/// </returns>
		/// <remarks>
		...
		{
			Module[] array = new Module[_data.Count];
		...
		private void AddRange(Module[] array, int range)
		{
			if (range == 0) return;

			if (_data.IsUnique)
			{
				foreach (Module value in array)
				{
					CheckUnique(value);
				}
			}
		...
		private void CheckUnique(Module value)
		{
			if (IndexOf(value) >= 0)
			{
		...
		private void CheckUnique(Module value, int index)
		{
		...
		private sealed class Data
		{
			...
			public void SetCapacity(int capacity)
			{
				...
				if (capacity == 0)
				{
					Items = new Module[DefaultCapacity];
					return;
				}

				Module[] items = new Module[capacity];
		...
		private sealed class ReadOnlyWrapper : ModuleArrayList
		{
			...
			public override int Add(Module value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(ModuleArrayList collection)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}

			public override void AddRange(Module[] array)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
			...
			{
				ModuleArrayList wrapper =
					(ModuleArrayList) base.Clone();

				return new ReadOnlyWrapper(wrapper._data);
			}

			public override void Insert(int index, Module value)
			{
				throw new NotSupportedException(
					"Read-only collections cannot be modified.");
			}
		...
		/// <summary>
		///     Method inherited from the IComparer interface
		/// </summary>
		...
		{
			return Compare((Module) x, (Module) y);
		}
