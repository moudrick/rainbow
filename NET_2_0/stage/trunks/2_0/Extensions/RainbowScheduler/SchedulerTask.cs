...
namespace Rainbow
{
	namespace Scheduler
	{
		...
		public class SchedulerTask
		{
			...
			public SchedulerTask(int idModuleOwner, int idModuleTarget, DateTime dueTime, string description) : this(idModuleOwner, idModuleTarget, dueTime)
			{
			...
			public SchedulerTask(int idModuleOwner, int idModuleTarget, DateTime dueTime, object argument) : this(idModuleOwner, idModuleTarget, dueTime)
			{
			...
			/// <param name="description"></param>
			/// <param name="argument"></param>
			public SchedulerTask(int idModuleOwner, int idModuleTarget, DateTime dueTime, string description, object argument) : this(idModuleOwner, idModuleTarget, dueTime, description)
			{
				if (!argument.GetType().IsSerializable)
					throw new ApplicationException("argument parameter must be a serializable type");
				_arg = argument;
			...
			internal SchedulerTask(int iDTask, int idModuleOwner, int idModuleTarget, DateTime dueTime, string description, object argument) : this(idModuleOwner, idModuleTarget, dueTime, description, argument)
			{
				_idTask = iDTask;
			}
