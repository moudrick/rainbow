    ...
    public class XmlEditGrid : DataGrid {
		...
		protected override void OnInit(EventArgs e) 
		{
            ...
            if (Page != null) {
                ...
                c0.EditText = "<img src='" + imagePath + "edit.gif' border=0 alt='" + Esperantus.Localize.GetString("XMLEDITGRID_EDITITEM", "edit this item") + "'>";
                c0.CancelText = "<img src='" + imagePath + "cancel.gif' border=0 alt='" + Esperantus.Localize.GetString("XMLEDITGRID_CANCEL", "cancel") + "'>";
                c0.UpdateText = "<img src='" + imagePath + "update.gif' border=0 alt='" + Esperantus.Localize.GetString("XMLEDITGRID_SAVE", "save changes") + "'>";
                ...
                c1.Text = "<img src='" + imagePath + "delete.gif' border=0 alt='" + Esperantus.Localize.GetString("XMLEDITGRID_DELETE", "delete this item") + "'>";
		...
		protected override void OnItemCreated(DataGridItemEventArgs e) {
            if ((ListItemType)e.Item.ItemType == ListItemType.Footer) {
                ...
                l.Text = Esperantus.Localize.GetString("XMLEDITGRID_ADD", "add new item");
