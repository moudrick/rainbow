	...
	public class ModuleButton : HtmlAnchor 
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			if ( this.TranslationKey.Length != 0 )
                this.InnerText = Esperantus.Localize.GetString(this.TranslationKey, this.EnglishName, this);
...
//			if ( this.PopUp )
//			{
//				if ( !((Rainbow.UI.Page)this.Page).IsClientScriptRegistered("rb-popup") )
//				((Rainbow.UI.Page)this.Page).RegisterClientScript("rb-popup",Rainbow.Settings.Path.ApplicationRoot + "/aspnet_client/popupHelper/popup.js");
//
//				if ( !((Rainbow.UI.Page)this.Page).IsClientPopUpEventListenerRegistered(this.Target) )
//				{
//					StringBuilder sb = new StringBuilder();
...
//					}
//					sb.Append(");");
//					((Rainbow.UI.Page)this.Page).RegisterClientPopUpEventListener(this.Target, sb.ToString());
//				}
//			}
//			//popup removed until fixed
//			base.OnPreRender(e);
