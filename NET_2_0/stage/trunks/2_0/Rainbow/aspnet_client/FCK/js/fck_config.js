...
config.ToolbarSets["Default"] = [
	['EditSource','Save','NewPage','Preview','-','Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck','Find','Replace','-','Undo','Redo','-','SelectAll','RemoveFormat','-','Link','RemoveLink','Anchor','-','Image','Table','Rule','SpecialChar','UniversalKey','Smiley'] ,
