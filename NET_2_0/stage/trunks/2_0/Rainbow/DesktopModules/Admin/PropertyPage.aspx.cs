...
namespace Rainbow.DesktopModules
{
	...
	public class PagePropertyPage : PropertyPage
	{
...
//			{
				...
				adminPropertiesButton.NavigateUrl = HttpUrlBuilder.BuildUrl("~/DesktopModules/Admin/ModuleSettings.aspx", PageID, ModuleID);
			...
			adminPropertiesButton2.NavigateUrl = HttpUrlBuilder.BuildUrl("~/DesktopModules/Admin/ModuleSettings.aspx", PageID, ModuleID);
...
//				((UI.Page)this.Page).RegisterCssFile("TabControl");
        ...
        private void PagePropertyPage_Load(object sender, EventArgs e)
        {
			...
			EditTable.UseGroupingTabs = Settings.Config.UseSettingsGroupingTabs;
			...
			// class -- Hongwei Shen
			EditTable.Width = Settings.Config.SettingsGroupingWidth;
			EditTable.Height = Settings.Config.SettingsGroupingHeight;
