...
namespace Rainbow.DesktopModules
{
	public class ContentManager : PortalModuleControl
	{
		...
		protected ListBox DestListBox;

		//drop down lists/combo boxes
		protected DropDownList ModuleTypes;
		protected DropDownList DestinationPortal;
		protected DropDownList SourceInstance;
		protected DropDownList DestinationInstance;

		//buttons
		protected LinkButton MoveLeft_Btn;
		protected LinkButton MoveRight_Btn;
		protected LinkButton CopyRight_Btn;
		protected LinkButton CopyAll_Btn;
		protected LinkButton DeleteLeft_Btn;
		protected LinkButton DeleteRight_Btn;
		protected Label SourcePortalLabel;
		protected System.Web.UI.WebControls.DropDownList SourcePortal;
		protected Label DestinationPortalLabel;

		protected HtmlTable MultiPortalTable;
		#endregion
		...
		private void LoadSourceModules()
		{
			if(ModuleTypes.SelectedIndex > -1)
			{
				...
				SourceInstance.DataSource = contentDB.GetModuleInstances(ModuleTypeID,Int32.Parse(SourcePortal.SelectedItem.Value));
		...
		public override void Install(IDictionary stateSaver)
		{
			...
			DirectoryInfo installDir = new DirectoryInfo(Path.Combine(Server.MapPath(TemplateSourceDirectory), "InstallScripts"));
