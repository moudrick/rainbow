...
namespace Rainbow.Configuration
{
	...
	[History("Manu","manu-dea@hotmail dot it","1.3","2004/05/16", "Commented out obsolete code or marked as obsolete. Will be removed in future versions.")]
	public class ErrorHandler
	{
		...
		public static void ProcessUnhandledException()
		{
			try
			{
				...
				if (HttpContext.Current.Request != null && HttpContext.Current.Request.Url.AbsolutePath.EndsWith(Config.SmartErrorRedirect.Substring(2)))
				{
			...
			{
				LogHelper.Log.Fatal("Unexpected error in ErrorHandler", ex);
			}
		}
		...
		/// </summary>
		/// <param name="_logLevel">Rainbow.Configuration.LogLevel enumerator</param>
