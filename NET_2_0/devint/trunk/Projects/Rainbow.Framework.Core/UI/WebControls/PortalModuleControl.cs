...
namespace Rainbow.Framework.Web.UI.WebControls
{
    ...
    public class PortalModuleControl : UserControl, ISearchable, IInstaller
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                version = Page.Request.QueryString["wversion" + ModuleConfiguration.ModuleID];
            }
            ...
            get
            {
                    ...
                    (ModuleConfiguration.DesktopSrc.Length != 0))
                {
                    string aux = Path.ApplicationRoot + "/rb_documentation/Rainbow/" +
                                 ModuleConfiguration.DesktopSrc.Replace(".", "_");
                    ...
                    if (CanProperties)
                    {
                        ...
                        if (PropertiesUrl.IndexOf("?") >= 0)
                            ...
                            propertiesButton.HRef =
                                HttpUrlBuilder.BuildUrl(PropertiesUrl, PageID, "mID=" + ModuleID);
                ...
                if (securityButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanSecurity)
                    {
                        ...
                        if (SecurityUrl.IndexOf("?") >= 0)
                            ...
                            securityButton.HRef =
                                HttpUrlBuilder.BuildUrl(SecurityUrl, PageID, "mID=" + ModuleID);
            ...
            get
            {
                if (deleteModuleButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanDeleteModule)
                    {
                        ...
                        deleteModuleButton.ServerClick += DeleteModuleButton_Click;
                    }
                }
        ...
        public ModuleButton HelpButton
        {
            get
            {
                if (helpButton == null && HttpContext.Current != null)
                {
                    ...
                    {
                        // build the HRef
                        string aux = ModuleConfiguration.DesktopSrc.Replace(".", "_");
            ...
            get
            {
                if (upButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanArrows && ModuleConfiguration.ModuleOrder != 1)
                    {
                        ...
                        upButton.ServerClick += UpDown_Click;
                    }
                }
                return upButton;
            }
                ...
                if (downButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanArrows)
                    {
                        ...
                        if (ModuleConfiguration.ModuleOrder != m.Order)
                        {
                            ...
                            downButton.ServerClick += UpDown_Click;
                        }
                    }
                }
                return downButton;
            ...
            get
            {
                if (leftButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanArrows && ModuleConfiguration.PaneName.ToLower() != "leftpane")
                    {
                        ...
                        leftButton.ServerClick += RightLeft_Click;
                    }
                }
                return leftButton;
            }
            ...
            get
            {
                if (rightButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanArrows && ModuleConfiguration.PaneName.ToLower() != "rightpane")
                    {
                        ...
                        rightButton.ServerClick += RightLeft_Click;
                    }
                }
                return rightButton;
            }
            ...
            get
            {
                if (revertButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanRequestApproval)
                    {
                        ...
                        revertButton.ServerClick += RevertToProductionContent;
            ...
            get
            {
                if (publishButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanPublish)
                    {
                        ...
                        publishButton.ServerClick += publishButton_ServerClick;
                        // end of modification
                ...
                if (editButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanEdit)
                    {
                        ...
                        if (EditUrl.IndexOf("?") >= 0) //Do not change if  the querystring is present
                            ...
                            editButton.HRef = HttpUrlBuilder.BuildUrl(EditUrl, PageID, "mID=" + ModuleID);
                ...
                if (addButton == null && HttpContext.Current != null)
                {
                    ...
                    if (CanAdd)
                    {
                        ...
                        if (AddUrl.IndexOf("?") >= 0) //Do not change if  the querystring is present
                            ...
                            AddButton.HRef = HttpUrlBuilder.BuildUrl(AddUrl, PageID, "mID=" + ModuleID);
...
//        /// </summary>
        ...
        private string GetOtherVersionUrl()
        {
            ...
            qs.Add("wversion" + ModuleConfiguration.ModuleID + "=" +
                   (Version == WorkFlowVersion.Production
        ...
        private void ProcessModuleStrecthing(Control moduleControl, bool isBeginTag)
        {
            if (moduleControl != null && moduleControl is LiteralControl)
            {
                ...
                bool isStretched = (Settings["MODULESETTINGS_WIDTH_STRETCHING"] != null &&
                                    bool.Parse(Settings["MODULESETTINGS_WIDTH_STRETCHING"].ToString()));
