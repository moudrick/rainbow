...
namespace Rainbow.Framework.Helpers
{
    ...
    public class IPList
    {
        ...
        /// Modified for Rainbow by Jeremy Esland (jes1111) 26/04/2005
        /// </summary>
        sealed class IPArrayList
        {
            bool isSorted = false;
            readonly ArrayList ipNumList = new ArrayList();
            readonly uint ipmask;
...
//            }
        ...
        readonly ArrayList ipRangeList = new ArrayList();
        readonly SortedList maskList = new SortedList();
        readonly ArrayList usedList = new ArrayList();
        ...
        public override string ToString()
        {
            ...
            foreach (int i in usedList)
            {
                ...
                buffer.Append(ipRangeList[i].ToString());
            }
