  ...
  <tr valign="top">
    <td class="Normal">
      <asp:PlaceHolder ID="UserDomain" runat="server" Visible="False">
        ...
        <br />
        <rbfwebui:Localize ID="DomainMessage2" runat="server" Text="Administrators may add domain users to specific roles using the Manage Roles section below."
      ...
      <asp:PlaceHolder ID="UserForm" runat="server" Visible="False">
        ...
        <br />
        <rbfwebui:Localize ID="FormsMessage2" runat="server" Text="Users may add themselves using the Register form, and Administrators may add users to specific roles using the Manage Roles section below."
