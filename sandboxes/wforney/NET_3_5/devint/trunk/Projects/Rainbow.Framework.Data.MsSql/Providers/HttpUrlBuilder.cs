...
namespace Rainbow.Framework.Data.Providers
{
    ...
    public class HttpUrlBuilder
    {
        ...
        {
            Rainbow.Framework.Data.MsSql.Portal currentSetting = null;

            if (HttpContext.Current.Items["PortalSettings"] != null)
                currentSetting = (Rainbow.Framework.Data.MsSql.Portal)HttpContext.Current.Items["PortalSettings"];
        ...
        /// <returns></returns>
        [Obsolete("Please use the new Rainbow.Framework.Configuration.Path.WebPathCombine()")]
