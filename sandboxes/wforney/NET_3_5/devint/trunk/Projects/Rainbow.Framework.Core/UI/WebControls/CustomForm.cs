namespace Rainbow.Framework.Web.UI.WebControls
{
    ...
    public class CustomForm : HtmlForm
    {
        ...
        /// <remarks>
        ///     Leave blank to postback to the same page.
        /// </remarks>
        ...
        public new virtual string Action
        {
            get
            {
                return this.ViewState["Action"] != null
                           ? (string)this.ViewState["Action"]
                           : this.GetBaseActionAttribute();
            }
        ...
        /// <summary>
        ///     Gets using reflection to access the ClientOnSubmitEvent property of the Page class
        /// </summary>
        /// <value>The page client on submit event.</value>
        private string PageClientOnSubmitEvent
        {
            get
            {
        ...
        protected override void RenderAttributes(HtmlTextWriter writer)
        {
            ...
            var submitEvent = this.PageClientOnSubmitEvent;
