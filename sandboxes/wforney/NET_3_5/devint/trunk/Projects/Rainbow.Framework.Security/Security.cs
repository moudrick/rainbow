namespace Rainbow.Framework.Security
{
    ...
    [History("jminond", "2004/09/29",
        "added killsession method mimic of sign out, as well as modified sign on to use cookieexpire in rainbow.config")
    ]
    ...
    public class PortalSecurity
    {
        ...
        /// <summary>
        /// The str portal settings.
        /// </summary>
        private const string StrPortalSettings = "PortalSettings";
        ...
        public static RainbowPrincipal CurrentUser
        {
            get
            {
                RainbowPrincipal r = HttpContext.Current.User is RainbowPrincipal
                                         ? (RainbowPrincipal)HttpContext.Current.User
                                         : new RainbowPrincipal(HttpContext.Current.User.Identity, null);
        ...
        /// The minute add.
        /// </param>
        public static void ExtendCookie(Portal portal, int minuteAdd)
        {
            var time = DateTime.Now;
            var span = new TimeSpan(0, 0, minuteAdd, 0, 0);

            HttpContext.Current.Response.Cookies[string.Format("Rainbow_{0}", portal.PortalAlias)].Expires = time.Add(span);
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have Add permissions for the specified module seperated by ;
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have delete module permission for the specified module seperated by ;
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have delete permissions for the specified module seperated by ;
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have Edit permissions seperated by ;
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have move module permission for the specified module seperated by ;
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have Properties permission for the specified module seperated by ;
        /// </returns>
        ...
        public static IList<RainbowRole> GetRoles()
        {
            ...
            var portalSettings = (PortalSettings)HttpContext.Current.Items[StrPortalSettings];
        ...
        /// </param>
        /// <returns>
        /// A list of roles that have View permissions for the specified module seperated by ;
        /// </returns>
        ...
        public static bool IsInRole(string role)
        {
            ...
            return useNtlm && (role == HttpContext.Current.User.Identity.Name || HttpContext.Current.User.IsInRole(role));
        }
        ...
        public static bool IsInRoles(string roles)
        {
            ...
            if (roles != null)
            {
                ...
                {
                    if (role.Length != 0 && ((role == "All Users") || IsInRole(role)))
                    {
                        return true;
                    }
        ...
        public static string SignOn(string user, string password, bool persistent, string redirectPage)
        {
            ...
            if (usr != null)
            {
                ...
                if (Config.EnableMonitoring)
                {
                    ...
                    {
                        Monitoring.LogEntry(
                            (Guid)(usr.ProviderUserKey ?? Guid.Empty), portalSettings.PortalID, -1, "Logon", string.Empty);
                    }
                    catch
                    {
                ...
                var hck = HttpContext.Current.Response.Cookies["Rainbow_" + portalSettings.PortalAlias.ToLower()];
                if (hck != null)
                {
        ...
        public static void SignOut(string urlToRedirect, bool removeLogin)
        {
            ...
            if (removeLogin)
            {
                ...
                var xhck = HttpContext.Current.Response.Cookies["Rainbow_" + portalSettings.PortalAlias.ToLower()];
                if (xhck != null)
                {
                    xhck.Value = null;
            ...
            if (HttpContext.Current.User != null)
            {
                ...
                // get user id
                var uid = (Guid)(user.ProviderUserKey ?? Guid.Empty);
        ...
        private static string getPermissions(int moduleID, string procedureName, string parameterRol)
        {
            ...
            using (var myCommand = new SqlCommand(procedureName, myConnection))
            {
                ...
                var parameterAccessRoles = new SqlParameter("@AccessRoles", SqlDbType.NVarChar, 256) { Direction = ParameterDirection.Output };
                myCommand.Parameters.Add(parameterAccessRoles);

                var parameterRoles = new SqlParameter(parameterRol, SqlDbType.NVarChar, 256) { Direction = ParameterDirection.Output };
