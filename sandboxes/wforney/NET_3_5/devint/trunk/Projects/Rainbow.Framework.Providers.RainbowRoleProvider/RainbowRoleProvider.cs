namespace Rainbow.Framework.Providers.RainbowRoleProvider
{
    ...
    public abstract class RainbowRoleProvider : RoleProvider
    {
        ...
        ///     The all users guid.
        /// </summary>
        private static Guid allUsersGuid = new Guid("{8E9E3841-A27A-49da-BC02-2048F1F1FD54}");

        /// <summary>
        ///     The authenticated users guid.
        /// </summary>
        private static Guid authenticatedUsersGuid = new Guid("{40D335D3-8C46-4009-B456-53F254959042}");

        /// <summary>
        ///     The unauthenticated users guid.
        /// </summary>
        private static Guid unauthenticatedUsersGuid = new Guid("{6E21FB8C-F345-4071-870B-151E79008B44}");
        ...
        /// <summary>
        ///     Gets or sets the all users guid.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the authenticated users guid.
        /// </summary>
        public static Guid AuthenticatedUsersGuid
        {
            get
            {
                return authenticatedUsersGuid;
            }

            set
            {
                authenticatedUsersGuid = value;
            }
        }

        /// <summary>
        ///     Gets or sets the unauthenticated users guid.
        /// </summary>
        public static Guid UnauthenticatedUsersGuid
        {
            get
            {
                return unauthenticatedUsersGuid;
            }

            set
            {
                unauthenticatedUsersGuid = value;
            }
        }
