namespace Rainbow.Framework.Web.UI.WebControls
{
    ...
    public class SettingsTable : WebControl, INamingContainer
    {
        ...
        /// <summary>
        /// The _grouping tabs created.
        /// </summary>
        private bool groupingTabsCreated;

        /// <summary>
        /// The _use grouping tabs.
        /// </summary>
        ...
        {
            foreach (var c in this.EditControls.Keys.Cast<string>().Select(key => (Control)this.EditControls[key]))
            {
        ...
        /// </summary>
        /// <param name="e">
        /// The <see cref="Rainbow.Framework.Web.UI.WebControls.SettingsTableEventArgs"/> instance containing the event data.
        /// </param>
        ...
        protected virtual SortedList ProcessDataSource()
        {
            ...
            foreach (string key in this.Settings.GetKeyList().Cast<string>().Where(key => this.Settings[key] != null))
            {
                ...
                {
                    int order = ((SettingItem)this.Settings[key]).Order;
        ...
        private void CreateGroupFlat(bool useDataSource, SortedList SettingsOrder)
        {
            ...
            foreach (string currentSetting in SettingsOrder.GetValueList())
            {
                ...
                if (currentItem.Group != currentGroup)
                {
                    ...
                    fieldset = this.CreateNewFieldSet(currentItem);
                ...
                img = new Image
                    {
                        ...
                        ToolTip = General.GetString(currentSetting + "_DESCRIPTION")
                    };
            ...
            var nameCell = new TableCell
                {
                    CssClass = "SubHead",
                    Text =
                        currentItem.EnglishName.Length == 0
                            ? General.GetString(currentSetting, string.Format("{0}<br />Key Not In Resources", currentSetting))
