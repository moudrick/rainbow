namespace Rainbow.Framework.Configuration.Cache
{
    ...
    public static class Key
    {
        ...
        /// </summary>
        /// <param name="moduleId">
        /// The Id of the module you wish to get the cache key for
        /// </param>
        /// <returns>
        ...
        /// </summary>
        /// <returns>
        /// Cache Key For Portal Base Settings
        /// </returns>
        ...
        public static string TabNavigationSettings(int tabId, string language)
        {
            return string.Concat(
                Portal.UniqueId, "_TabNavigationSettings_", tabId.ToString(CultureInfo.InvariantCulture), language);
        }
        ...
        /// </summary>
        /// <param name="tabId">
        /// The Id of the tab you wish to get the cache key for
        /// </param>
        /// <returns>
