...
namespace Rainbow.Framework.Providers.MsSql
{
    ...
    public class RainbowSqlMembershipProvider : RainbowMembershipProvider.RainbowMembershipProvider
    {
        ...
        const int errorCode_UserLockedOut = 99;

        const int newPasswordLength = 8;
        const string encryptionKey = "BE09F72BFF7A4566";
        ...
        {
            return
                ChangePasswordQuestionAndAnswer(ApplicationName,
                                                username,
                                                password,
                                                newPasswordQuestion,
                                                newPasswordAnswer);
            ...
            try
            {
                ...
                using (reader = sqlCommand.ExecuteReader())
                {
                    if (reader.HasRows)
                    {
                        ...
                        string passwordQuestion = reader.IsDBNull(1)
                                                      ? string.Empty
                                                      : reader.GetString(1);
                        ...
                        DateTime creationDate = reader.IsDBNull(4)
                                                    ? DateTime.Now
                                                    : reader.GetDateTime(4);
                        DateTime lastLoginDate = reader.IsDBNull(5)
                                                     ? DateTime.Now
                                                     : reader.GetDateTime(5);
                        DateTime lastActivityDate = reader.IsDBNull(6)
                                                        ? DateTime.Now
                                                        : reader.GetDateTime(6);
                        DateTime lastPasswordChangedDate = reader.IsDBNull(7)
                                                               ? DateTime.Now
                        ...
                        DateTime lastLockedOutDate = reader.IsDBNull(10)
                                                         ? DateTime.Now
        ...
        {
            return
                FindUsersByEmail(ApplicationName,
                                 emailToMatch,
                                 pageIndex,
                                 pageSize,
                                 out totalRecords);
        ...
        {
            return
                FindUsersByName(ApplicationName,
                                usernameToMatch,
                                pageIndex,
                                pageSize,
                                out totalRecords);
        ...
        public override bool ChangePassword(string portalAlias,
                                            string username,
                                            string oldPassword,
                                            string newPassword)
        {
        ...
        public override bool ChangePasswordQuestionAndAnswer(string portalAlias,
                                                             string username,
                                                             string password,
                                                             string newPasswordQuestion,
                                                             string newPasswordAnswer)
        {
            ...
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NVarChar, 256).Value = portalAlias;
            cmd.Parameters.Add("@Username", SqlDbType.NVarChar, 255).Value = username;
            cmd.Parameters.Add("@NewPasswordQuestion", SqlDbType.NVarChar, 255).Value =
                newPasswordQuestion;
            cmd.Parameters.Add("@NewPasswordAnswer", SqlDbType.NVarChar, 255).Value =
                newPasswordAnswer;
            ...
            catch (SqlException e)
            {
                ...
                throw new RainbowMembershipProviderException(
                    "Error executing aspnet_Membership_ChangePasswordQuestionAndAnswer stored proc",
                    e);
            }
            finally
            {
                                                  ...
                                                  out MembershipCreateStatus status)
        {
            ...
            cmd.Parameters.Add("@PasswordQuestion", SqlDbType.NVarChar, 255).Value =
                passwordQuestion;
        ...
        public override bool DeleteUser(string portalAlias,
                                        string username,
                                        bool deleteAllRelatedData)
        {
            ...
            SqlParameter tablesDeletedFrom =
            ...
            catch (SqlException e)
            {
                ...
                throw new RainbowMembershipProviderException(
                    "Error executing aspnet_Users_DeleteUser stored proc", e);
            }
            finally
            {
                cmd.Connection.Close();
        ...
        {
//            TimeSpan onlineSpan =
//                new TimeSpan(0, Membership.UserIsOnlineTimeWindow, 0);
            ...
            cmd.Parameters.Add("@ApplicationName", SqlDbType.NVarChar, 256).Value = portalAlias;
            cmd.Parameters.Add("@MinutesSinceLastInActive", SqlDbType.Int).Value =
...
//                            Enum.Parse(typeof (MembershipPasswordFormat),
//                                       reader.GetInt32(1).ToString());
                    ...
                    switch (returnCode)
                    {
                        case errorCode_UserNotFound:
                            throw new RainbowMembershipProviderException(
                                "The supplied user name was not found.");
                        case errorCode_IncorrectPasswordAnswer:
                            throw new MembershipPasswordException("Incorrect password answer.");
                        case errorCode_UserLockedOut:
        ...
        public override MembershipUser GetUser(string portalAlias,
                                               string username,
                                               bool userIsOnline)
        {
            SqlCommand cmd = new SqlCommand();
        ...
        public override void UpdateUser(string portalAlias, MembershipUser user)
        {
            ...
            cmd.Parameters.Add("@LastActivityDate", SqlDbType.DateTime).Value =
        ...
        public override MembershipUserCollection FindUsersByName(string portalAlias,
        ...
        public override MembershipUserCollection FindUsersByEmail(string portalAlias,
                                                                  string emailToMatch,
                                                                  int pageIndex,
                                                                  int pageSize,
                                                                  out int totalRecords)
        ...
        public override string ResetPassword(string portalAlias, string username, string answer)
        {
            ...
            try
            {
                ...
                switch (returnCode)
                {
                    ...
                    case errorCode_IncorrectPasswordAnswer:
                        throw new MembershipPasswordException(
                            "The supplied password answer is incorrect.");
                    case errorCode_UserLockedOut:
                        throw new RainbowMembershipProviderException(
        ...
        string UnEncodePassword(string encodedPassword)
        {
            ...
            switch (PasswordFormat)
            {
                ...
                case MembershipPasswordFormat.Hashed:
                    throw new RainbowMembershipProviderException(
                        "Cannot unencode a hashed password.");
                default:
                    throw new RainbowMembershipProviderException("Unsupported password format.");
            }
        ...
        static void WriteToEventLog(Exception ex, string action)
        {
        ...
        protected virtual RainbowUser GetUserFromReader(SqlDataReader reader)
        {
            ...
            DateTime lastPasswordChangedDate = reader.IsDBNull(8)
                                                   ? DateTime.Now
            ...
            return InstanciateNewUser(Name,
                                   username,
                                   providerUserKey,
                                   email,
                                   passwordQuestion,
                           ...
                           MembershipPasswordFormat passwordFormat)
        {
            ...
            switch (passwordFormat)
            {
                case MembershipPasswordFormat.Encrypted:
                    ...
                    break;
                case MembershipPasswordFormat.Hashed:
                    pass1 = EncodePassword(passwordSalt + password);
                    break;
                default:
                    break;
            }
