...
namespace Rainbow.Framework.Core.Configuration.Settings.Providers
{
    ...
    public class PortalProvider //: ProviderBase
    {
        ...
        /// <param name="portalPath">The portal path.</param>
        /// <returns></returns>
        public int CreatePortal(int templateID,
                                ...
                                string portalPath)
        {
            ...
            while (myReader.Read())
            {
                RainbowContext.Current.UpdatePortalSetting(newPortalID,
        ...
        /// <param name="portalPath">The portal path.</param>
        /// <returns></returns>
        public Hashtable GetPortalBaseSettings(string portalPath)
        {
        ...
        /// <returns></returns>
        public Hashtable GetPortalCustomSettings(int portalID, Hashtable baseSettings)
        {
        ...
        /// </summary>
        /// <param name="portalPath">The portal path.</param>
        public void FlushBaseSettingsCache(string portalPath)
        {
        ...
        /// <param name="tabList">The tab list.</param>
        /// <returns></returns>
        public PageStripDetails GetRootPage(int parentPageID, ArrayList tabList)
        {
        ...
        /// <param name="tabList">The tab list.</param>
        /// <returns></returns>
        public PageStripDetails GetRootPage(PageSettings tab, ArrayList tabList)
        {
            return GetRootPage(tab.PageID, tabList);
        }

        internal void FillPortalSettingsFull(PortalSettings portal, int pageID, string portalAlias)
        {
