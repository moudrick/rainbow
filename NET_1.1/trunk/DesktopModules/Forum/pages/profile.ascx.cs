...
namespace yaf.pages
{
	...
	public class profile : ForumPage
	{
		...
		protected HtmlTableRow SuspendedRow, userGroupsRow, SuspendUser;//KAW
		protected HtmlTable  SuspendSection;//KAW
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if((this.IsGuest))
			{
				SuspendSection.Visible=false;
			}
			else if (!this.IsGuest && (this.IsAdmin || this.IsModerator))
			{
				SuspendSection.Visible=true;
			}
