...
<HTML>
	<HEAD>
		<title>Rainbow Forum Installation</title>
	...
	<body>
		<form runat="server">
			<table class="content" width="100%" cellspacing="1" cellpadding="0">
				<tr>
					<td class="header1">Rainbow Forum Installation</td>
				</tr>
				<tr>
					<td class="post">
						<table cellspacing="1" cellpadding="0" width="100%" runat="server" id="stepWelcome">
							...
							<tr>
								<td colspan="2">
									<p>
										This installation wizard that will guide you through the installation of the 
										Rainbow Forum.
									</p>
									<p>
							...
							<tr>
								<td colspan="2">
									...
									<asp:placeholder runat="server" id="ConfigSample" visible="False">
										<P>Here is an example &lt;yafnet&gt; section:
										</P>
										<PRE>&lt;configuration&gt;
	&lt;configSections&gt;
	...
	&lt;/configSections&gt;
	&lt;yafnet&gt;
		&lt;connstr&gt;user id=yaf;password=yafpass;data source=(local);initial catalog=rainbowforum&lt;/connstr&gt;
		&lt;language&gt;english.xml&lt;/language&gt;
		&lt;theme&gt;standard.xml&lt;/theme&gt;
		&lt;uploaddir&gt;/Forum/upload/&lt;/uploaddir&gt;
	&lt;/yafnet&gt;
&lt;/configuration&gt;
		</PRE>
									</asp:placeholder>
						...
						<table cellspacing="1" cellpadding="0" width="100%" runat="server" visible="false" id="stepConnect">
							...
							<tr>
								<td colspan="2">
									...
									<p>
										When you have entered the correct connection string, click next to continue 
						...
						<table cellspacing="1" cellpadding="0" width="100%" runat="server" visible="false" id="stepDatabase">
							...
							<tr>
								<td>
									<p>
										Your database will now be initialized. In a fresh install this means creating 
										all tables and stored procedures. If this is an update to an already existing 
										version, y?our database w?ill be updated to the latest version.
									</p>
									<p>
						...
						<table width="100%" cellspacing="1" cellpadding="0" runat="server" visible="false" id="stepForum">
							...
							<tr>
								<td class="postheader"><b>Forum Name:</b><br>
							...
							<tr>
								<td class="postheader"><b>Admin User Name:</b><br>
									The name of the admin user.</td>
								<td class="post">
									<asp:TextBox id="UserName" runat="server" ReadOnly="True" BackColor="#E0E0E0"></asp:TextBox>
								</td>
							</tr>
							<tr>
								<td class="postheader"><b>Admin Email:</b><br>
									The administrators email address.</td>
								<td class="post">
									<asp:TextBox id="AdminEmail" runat="server" ReadOnly="True" BackColor="#E0E0E0"></asp:TextBox>
								</td>
							</tr>
						</table>
			...
			<yaf:smartscroller runat="server" id="Smartscroller1" />
		</form>
	</body>
</HTML>
