...
namespace Rainbow.DesktopModules
{
	...
	public class Events : PortalModuleControl
	{
		...
		/// 
		/// </summary>
		protected Label lblCalendar;
		/// <summary>
		/// 
		/// </summary>
		protected Label lblDisplayDate;
		/// <summary>
		/// 
		/// </summary>
		protected TextBox txtDisplayMonth;
		/// <summary>
		/// 
		/// </summary>
		protected TextBox txtDisplayYear;
		/// <summary>
		/// 
		/// </summary>
		protected LinkButton PreviousMonth;
		/// <summary>
		/// 
		/// </summary>
		protected LinkButton NextMonth;
		/// <summary>
		/// 
		/// </summary>
		protected Panel CalendarPanel;
		/// <summary>
		/// 
		/// </summary>
		...
		{
			SearchDefinition s = new SearchDefinition("rb_Events", "Title", "Description", "CreatedByUser", "CreatedDate", searchField);
...
//			Controls.AddAt(0, ModuleTitle);
		...
		{
			// devsolution 2003/6/17: Added items for calendar control
			this.PreviousMonth.Click += new EventHandler(this.PreviousMonth_Click);
			this.NextMonth.Click += new EventHandler(this.NextMonth_Click);
			// devsolution 2003/6/17: Finish - Added items for calendar control
