...
namespace Rainbow.AdminAll
{
    ...
    public class AddNewPortal : AddItemPage
    {
        /// <summary>
        /// 
        /// </summary>
        protected DropDownList SolutionsList;
        /// <summary>
        /// 
        /// </summary>
		protected TextBox AliasField;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
		protected RequiredFieldValidator RequiredAlias;
        /// <summary>
        /// 
        /// </summary>
		protected RequiredFieldValidator RequiredSitepath;
        /// <summary>
        /// 
        /// </summary>
...
//                PortalSecurity.AccessDeniedEdit();
        ...
        protected override void OnUpdate(EventArgs e) 
        {
			...
			if(Page.IsValid)
			{
				...
				{
					string aux = Localize.GetString("NEW_PORTAL_ERROR", "There was an error on creating the portal", this);
		...
		private int CreatePortal(int templateID, string templateAlias, string portalAlias, string portalName, string portalPath) 
		{
			...
			while (myReader.Read()) 
			{
				...
				tab.newID = tabs.AddPage(newPortalID, myReader["TabName"].ToString(), Int32.Parse(myReader["TabOrder"].ToString()));
			...
			while (myReader.Read()) 
			{
				...
				tabs.UpdatePage(newPortalID, newTabID, newParentTabID, myReader["TabName"].ToString(), 
				...
				try
				{
					...
					result = GetPageModules(Int32.Parse(myReader["TabID"].ToString()), my2ndConnection);
		...
		private Guid GetGeneralModuleDefinitionByName(string moduleName, SqlConnection myConnection)
		{
			...
			if (parameterModuleID.Value != null && parameterModuleID.Value.ToString().Length != 0)
			{
				...
				{
					ErrorHandler.Publish(LogLevel.Error, "'" + parameterModuleID.Value.ToString() + "' seems not a valid GUID.", ex);
					throw;
				}
			}
			else
		...
		override protected void OnInit(EventArgs e)
		{
			...
			RequiredAlias.ErrorMessage = Localize.GetString("VALID_FIELD");
			RequiredSitepath.ErrorMessage = Localize.GetString("VALID_FIELD");
